...
*AdAccountsApi* | [**getDsaRecommendations**](docs/Api/AdAccountsApi.md#getdsarecommendations) | **GET** /v1/ads/dsa-recommendations | Get DSA recommendations
...
*AdAccountsApi* | [**listAdsInstagramAccounts**](docs/Api/AdAccountsApi.md#listadsinstagramaccounts) | **GET** /v1/ads/instagram-accounts | List Instagram ad identities
*AdAccountsApi* | [**listAdsInstagramPosts**](docs/Api/AdAccountsApi.md#listadsinstagramposts) | **GET** /v1/ads/instagram-posts | List Instagram posts to boost
...
*AdCampaignsApi* | [**listBidStrategies**](docs/Api/AdCampaignsApi.md#listbidstrategies) | **GET** /v1/ads/bid-strategies | List portfolio bid strategies
*AdCampaignsApi* | [**listCampaignAssets**](docs/Api/AdCampaignsApi.md#listcampaignassets) | **GET** /v1/ads/campaigns/{campaignId}/assets | List campaign assets
...
*AdCampaignsApi* | [**updateAdGroupAssets**](docs/Api/AdCampaignsApi.md#updateadgroupassets) | **PUT** /v1/ads/ad-sets/{adSetId}/assets | Update ad-group assets
*AdCampaignsApi* | [**updateAdKeyword**](docs/Api/AdCampaignsApi.md#updateadkeyword) | **PATCH** /v1/ads/keywords/{keywordId} | Pause or enable a Search keyword
...
*AdCreativesApi* | [**listAdsTikTokIdentities**](docs/Api/AdCreativesApi.md#listadstiktokidentities) | **GET** /v1/ads/tiktok-identities | List TikTok ad identities
*AdCreativesApi* | [**listPartnershipAdContent**](docs/Api/AdCreativesApi.md#listpartnershipadcontent) | **GET** /v1/ads/partnership-content | List partnership ad content
*AdCreativesApi* | [**listPartnershipAdPermissions**](docs/Api/AdCreativesApi.md#listpartnershipadpermissions) | **GET** /v1/ads/partnership-permissions | List partnership permissions
*AdCreativesApi* | [**setPartnershipAdPermission**](docs/Api/AdCreativesApi.md#setpartnershipadpermission) | **POST** /v1/ads/partnership-permissions | Set partnership permission
...
*AdInsightsApi* | [**createAdInsightsReport**](docs/Api/AdInsightsApi.md#createadinsightsreport) | **POST** /v1/ads/insights/reports | Submit async insights report
*AdInsightsApi* | [**generateKeywordHistoricalMetrics**](docs/Api/AdInsightsApi.md#generatekeywordhistoricalmetrics) | **POST** /v1/ads/keywords/historical-metrics | Get historical keyword metrics
*AdInsightsApi* | [**generateKeywordIdeas**](docs/Api/AdInsightsApi.md#generatekeywordideas) | **POST** /v1/ads/keywords/ideas | Generate keyword ideas
...
*AdInsightsApi* | [**getTikTokSmartPlusMaterialReport**](docs/Api/AdInsightsApi.md#gettiktoksmartplusmaterialreport) | **GET** /v1/ads/tiktok-smart-plus-materials | Per-creative performance inside TikTok Smart+ ads
*AdInsightsApi* | [**listLocalServicesLeadConversations**](docs/Api/AdInsightsApi.md#listlocalservicesleadconversations) | **GET** /v1/ads/local-services/leads/{leadId}/conversations | List lead conversations
...
*AdTargetingApi* | [**getLinkedInSupplyForecast**](docs/Api/AdTargetingApi.md#getlinkedinsupplyforecast) | **POST** /v1/ads/targeting/supply-forecast | Forecast ad delivery
...
*AnalyticsApi* | [**getGoogleBusinessPerformance**](docs/Api/AnalyticsApi.md#getgooglebusinessperformance) | **GET** /v1/analytics/googlebusiness/performance | Get Google Business Profile performance metrics
*AnalyticsApi* | [**getGoogleBusinessSearchKeywords**](docs/Api/AnalyticsApi.md#getgooglebusinesssearchkeywords) | **GET** /v1/analytics/googlebusiness/search-keywords | Get Google Business Profile search keywords
...
*BusinessAgentApi* | [**addBusinessAgentAllowlistEntry**](docs/Api/BusinessAgentApi.md#addbusinessagentallowlistentry) | **POST** /v1/accounts/{accountId}/business-agent/allowlist | Allowlist a consumer
*BusinessAgentApi* | [**addBusinessAgentWebsite**](docs/Api/BusinessAgentApi.md#addbusinessagentwebsite) | **POST** /v1/accounts/{accountId}/business-agent/websites | Add a website to crawl
*BusinessAgentApi* | [**createBusinessAgentConnector**](docs/Api/BusinessAgentApi.md#createbusinessagentconnector) | **POST** /v1/accounts/{accountId}/business-agent/connectors | Create a connector
*BusinessAgentApi* | [**createBusinessAgentConnectorTool**](docs/Api/BusinessAgentApi.md#createbusinessagentconnectortool) | **POST** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools | Create a connector tool
*BusinessAgentApi* | [**createBusinessAgentFaq**](docs/Api/BusinessAgentApi.md#createbusinessagentfaq) | **POST** /v1/accounts/{accountId}/business-agent/faqs | Create a FAQ
*BusinessAgentApi* | [**createBusinessAgentSkill**](docs/Api/BusinessAgentApi.md#createbusinessagentskill) | **POST** /v1/accounts/{accountId}/business-agent/skills | Create a skill
*BusinessAgentApi* | [**createBusinessAgentUiSkill**](docs/Api/BusinessAgentApi.md#createbusinessagentuiskill) | **POST** /v1/accounts/{accountId}/business-agent/ui-skills | Create a UI skill
*BusinessAgentApi* | [**deleteBusinessAgentConnector**](docs/Api/BusinessAgentApi.md#deletebusinessagentconnector) | **DELETE** /v1/accounts/{accountId}/business-agent/connectors/{connectorId} | Delete a connector
*BusinessAgentApi* | [**deleteBusinessAgentConnectorTool**](docs/Api/BusinessAgentApi.md#deletebusinessagentconnectortool) | **DELETE** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools/{toolId} | Delete a connector tool
*BusinessAgentApi* | [**deleteBusinessAgentFaq**](docs/Api/BusinessAgentApi.md#deletebusinessagentfaq) | **DELETE** /v1/accounts/{accountId}/business-agent/faqs/{faqId} | Delete a FAQ
*BusinessAgentApi* | [**deleteBusinessAgentFile**](docs/Api/BusinessAgentApi.md#deletebusinessagentfile) | **DELETE** /v1/accounts/{accountId}/business-agent/files/{fileId} | Delete a knowledge file
*BusinessAgentApi* | [**deleteBusinessAgentSkill**](docs/Api/BusinessAgentApi.md#deletebusinessagentskill) | **DELETE** /v1/accounts/{accountId}/business-agent/skills/{skillId} | Delete a skill
*BusinessAgentApi* | [**deleteBusinessAgentUiSkill**](docs/Api/BusinessAgentApi.md#deletebusinessagentuiskill) | **DELETE** /v1/accounts/{accountId}/business-agent/ui-skills/{uiSkillId} | Delete a UI skill
*BusinessAgentApi* | [**deleteBusinessAgentWebsite**](docs/Api/BusinessAgentApi.md#deletebusinessagentwebsite) | **DELETE** /v1/accounts/{accountId}/business-agent/websites/{websiteId} | Remove a crawled website
*BusinessAgentApi* | [**getBusinessAgentBudget**](docs/Api/BusinessAgentApi.md#getbusinessagentbudget) | **GET** /v1/accounts/{accountId}/business-agent/budget | Get usage budgets
*BusinessAgentApi* | [**getBusinessAgentBusinessInformation**](docs/Api/BusinessAgentApi.md#getbusinessagentbusinessinformation) | **GET** /v1/accounts/{accountId}/business-agent/business-information | Get business information
*BusinessAgentApi* | [**getBusinessAgentConnector**](docs/Api/BusinessAgentApi.md#getbusinessagentconnector) | **GET** /v1/accounts/{accountId}/business-agent/connectors/{connectorId} | Get a connector
*BusinessAgentApi* | [**getBusinessAgentConnectorLogs**](docs/Api/BusinessAgentApi.md#getbusinessagentconnectorlogs) | **GET** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/logs | Get connector failure logs
*BusinessAgentApi* | [**getBusinessAgentConnectorTool**](docs/Api/BusinessAgentApi.md#getbusinessagentconnectortool) | **GET** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools/{toolId} | Get a connector tool
*BusinessAgentApi* | [**getBusinessAgentEvent**](docs/Api/BusinessAgentApi.md#getbusinessagentevent) | **GET** /v1/accounts/{accountId}/business-agent/events/{eventId} | Get a business event status
*BusinessAgentApi* | [**getBusinessAgentFaq**](docs/Api/BusinessAgentApi.md#getbusinessagentfaq) | **GET** /v1/accounts/{accountId}/business-agent/faqs/{faqId} | Get a FAQ
*BusinessAgentApi* | [**getBusinessAgentFile**](docs/Api/BusinessAgentApi.md#getbusinessagentfile) | **GET** /v1/accounts/{accountId}/business-agent/files/{fileId} | Get a knowledge file
*BusinessAgentApi* | [**getBusinessAgentSkill**](docs/Api/BusinessAgentApi.md#getbusinessagentskill) | **GET** /v1/accounts/{accountId}/business-agent/skills/{skillId} | Get a skill
*BusinessAgentApi* | [**getBusinessAgentStatus**](docs/Api/BusinessAgentApi.md#getbusinessagentstatus) | **GET** /v1/accounts/{accountId}/business-agent | Get agent setup status
*BusinessAgentApi* | [**getBusinessAgentUiSkill**](docs/Api/BusinessAgentApi.md#getbusinessagentuiskill) | **GET** /v1/accounts/{accountId}/business-agent/ui-skills/{uiSkillId} | Get a UI skill
*BusinessAgentApi* | [**getBusinessAgentWebsite**](docs/Api/BusinessAgentApi.md#getbusinessagentwebsite) | **GET** /v1/accounts/{accountId}/business-agent/websites/{websiteId} | Get a crawled website
*BusinessAgentApi* | [**listBusinessAgentAllowlist**](docs/Api/BusinessAgentApi.md#listbusinessagentallowlist) | **GET** /v1/accounts/{accountId}/business-agent/allowlist | List allowlisted consumers
*BusinessAgentApi* | [**listBusinessAgentConnectorTools**](docs/Api/BusinessAgentApi.md#listbusinessagentconnectortools) | **GET** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools | List connector tools
*BusinessAgentApi* | [**listBusinessAgentConnectors**](docs/Api/BusinessAgentApi.md#listbusinessagentconnectors) | **GET** /v1/accounts/{accountId}/business-agent/connectors | List connectors
*BusinessAgentApi* | [**listBusinessAgentFaqs**](docs/Api/BusinessAgentApi.md#listbusinessagentfaqs) | **GET** /v1/accounts/{accountId}/business-agent/faqs | List FAQs
*BusinessAgentApi* | [**listBusinessAgentFiles**](docs/Api/BusinessAgentApi.md#listbusinessagentfiles) | **GET** /v1/accounts/{accountId}/business-agent/files | List knowledge files
*BusinessAgentApi* | [**listBusinessAgentSettings**](docs/Api/BusinessAgentApi.md#listbusinessagentsettings) | **GET** /v1/accounts/{accountId}/business-agent/settings | List agent settings
*BusinessAgentApi* | [**listBusinessAgentSkills**](docs/Api/BusinessAgentApi.md#listbusinessagentskills) | **GET** /v1/accounts/{accountId}/business-agent/skills | List skills
*BusinessAgentApi* | [**listBusinessAgentUiSkills**](docs/Api/BusinessAgentApi.md#listbusinessagentuiskills) | **GET** /v1/accounts/{accountId}/business-agent/ui-skills | List UI skills
*BusinessAgentApi* | [**listBusinessAgentWebsites**](docs/Api/BusinessAgentApi.md#listbusinessagentwebsites) | **GET** /v1/accounts/{accountId}/business-agent/websites | List crawled websites
*BusinessAgentApi* | [**onboardBusinessAgent**](docs/Api/BusinessAgentApi.md#onboardbusinessagent) | **POST** /v1/accounts/{accountId}/business-agent/onboard | Create the agent
*BusinessAgentApi* | [**readBusinessAgentEvals**](docs/Api/BusinessAgentApi.md#readbusinessagentevals) | **GET** /v1/accounts/{accountId}/business-agent/evals | Read evaluation data
*BusinessAgentApi* | [**refreshBusinessAgentConnectorTools**](docs/Api/BusinessAgentApi.md#refreshbusinessagentconnectortools) | **POST** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/refresh-tools | Refresh MCP connector tools
*BusinessAgentApi* | [**removeBusinessAgentAllowlistEntry**](docs/Api/BusinessAgentApi.md#removebusinessagentallowlistentry) | **DELETE** /v1/accounts/{accountId}/business-agent/allowlist/{entryId} | Remove an allowlisted consumer
*BusinessAgentApi* | [**replaceBusinessAgentBudget**](docs/Api/BusinessAgentApi.md#replacebusinessagentbudget) | **PUT** /v1/accounts/{accountId}/business-agent/budget | Replace usage budgets
*BusinessAgentApi* | [**replaceBusinessAgentBusinessInformation**](docs/Api/BusinessAgentApi.md#replacebusinessagentbusinessinformation) | **PUT** /v1/accounts/{accountId}/business-agent/business-information | Replace business information
*BusinessAgentApi* | [**resetBusinessAgentBusinessInformation**](docs/Api/BusinessAgentApi.md#resetbusinessagentbusinessinformation) | **DELETE** /v1/accounts/{accountId}/business-agent/business-information | Reset business information
*BusinessAgentApi* | [**runBusinessAgentConnectorTool**](docs/Api/BusinessAgentApi.md#runbusinessagentconnectortool) | **POST** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools/{toolId}/run | Run a connector tool once
*BusinessAgentApi* | [**sendBusinessAgentEvent**](docs/Api/BusinessAgentApi.md#sendbusinessagentevent) | **POST** /v1/accounts/{accountId}/business-agent/events | Send a business event
*BusinessAgentApi* | [**sendBusinessAgentTestMessage**](docs/Api/BusinessAgentApi.md#sendbusinessagenttestmessage) | **POST** /v1/accounts/{accountId}/business-agent/test-messages | Send a test message
*BusinessAgentApi* | [**setBusinessAgentConnectorCredentials**](docs/Api/BusinessAgentApi.md#setbusinessagentconnectorcredentials) | **POST** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/credentials | Set connector credentials
*BusinessAgentApi* | [**startBusinessAgentEvalRun**](docs/Api/BusinessAgentApi.md#startbusinessagentevalrun) | **POST** /v1/accounts/{accountId}/business-agent/evals | Start an evaluation run
*BusinessAgentApi* | [**updateBusinessAgentConnector**](docs/Api/BusinessAgentApi.md#updatebusinessagentconnector) | **PUT** /v1/accounts/{accountId}/business-agent/connectors/{connectorId} | Update a connector
*BusinessAgentApi* | [**updateBusinessAgentConnectorTool**](docs/Api/BusinessAgentApi.md#updatebusinessagentconnectortool) | **PUT** /v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools/{toolId} | Update a connector tool
*BusinessAgentApi* | [**updateBusinessAgentFaq**](docs/Api/BusinessAgentApi.md#updatebusinessagentfaq) | **PUT** /v1/accounts/{accountId}/business-agent/faqs/{faqId} | Update a FAQ
*BusinessAgentApi* | [**updateBusinessAgentSettings**](docs/Api/BusinessAgentApi.md#updatebusinessagentsettings) | **PATCH** /v1/accounts/{accountId}/business-agent/settings | Update agent settings
*BusinessAgentApi* | [**updateBusinessAgentSkill**](docs/Api/BusinessAgentApi.md#updatebusinessagentskill) | **PUT** /v1/accounts/{accountId}/business-agent/skills/{skillId} | Update a skill
*BusinessAgentApi* | [**updateBusinessAgentUiSkill**](docs/Api/BusinessAgentApi.md#updatebusinessagentuiskill) | **PUT** /v1/accounts/{accountId}/business-agent/ui-skills/{uiSkillId} | Update a UI skill
*BusinessAgentApi* | [**updateBusinessAgentWebsite**](docs/Api/BusinessAgentApi.md#updatebusinessagentwebsite) | **PUT** /v1/accounts/{accountId}/business-agent/websites/{websiteId} | Update a crawled website
*BusinessAgentApi* | [**uploadBusinessAgentFile**](docs/Api/BusinessAgentApi.md#uploadbusinessagentfile) | **POST** /v1/accounts/{accountId}/business-agent/files | Upload a knowledge file
...
*ConnectApi* | [**getPageWebhookSubscription**](docs/Api/ConnectApi.md#getpagewebhooksubscription) | **GET** /v1/accounts/{accountId}/webhook-subscription | Read a Facebook Page&#39;s webhook subscription
...
*ConnectApi* | [**listGoogleBusinessLocations**](docs/Api/ConnectApi.md#listgooglebusinesslocations) | **GET** /v1/connect/googlebusiness/locations | List Google Business Profile locations
...
*ConnectApi* | [**listSlackChannels**](docs/Api/ConnectApi.md#listslackchannels) | **GET** /v1/connect/slack | List Slack channels for the channel picker
...
*ConnectApi* | [**resyncPageWebhookSubscription**](docs/Api/ConnectApi.md#resyncpagewebhooksubscription) | **POST** /v1/accounts/{accountId}/webhook-subscription | Re-subscribe a Facebook Page to Zernio&#39;s webhooks
...
*ConnectApi* | [**selectGoogleBusinessLocation**](docs/Api/ConnectApi.md#selectgooglebusinesslocation) | **POST** /v1/connect/googlebusiness/select-location | Select Google Business Profile location
...
*ConnectApi* | [**updateGmbLocation**](docs/Api/ConnectApi.md#updategmblocation) | **PUT** /v1/accounts/{accountId}/gmb-locations | Update Google Business Profile location
...
*IMessageApi* | [**getImessageGroup**](docs/Api/IMessageApi.md#getimessagegroup) | **GET** /v1/imessage/groups/{conversationId} | Get an iMessage group
...
*IMessageApi* | [**updateImessageSender**](docs/Api/IMessageApi.md#updateimessagesender) | **PATCH** /v1/imessage/senders/{senderId} | Update an iMessage sender
...
*LeadGenApi* | [**deleteTestLead**](docs/Api/LeadGenApi.md#deletetestlead) | **DELETE** /v1/ads/lead-forms/{formId}/test-leads | Delete a test lead
...
*MessagingAdsApi* | [**createCtwaAd**](docs/Api/MessagingAdsApi.md#createctwaad) | **POST** /v1/ads/ctwa | Create CTWA ad (deprecated)
*MessagingAdsApi* | [**createMessagingAd**](docs/Api/MessagingAdsApi.md#createmessagingad) | **POST** /v1/ads/messaging | Create messaging ad
...
*ReachAndFrequencyApi* | [**reserveRfPrediction**](docs/Api/ReachAndFrequencyApi.md#reserverfprediction) | **POST** /v1/ads/rf-predictions/{predictionId}/reserve | Reserve reach-frequency inventory
...
*UsageApi* | [**getXApiPricing**](docs/Api/UsageApi.md#getxapipricing) | **GET** /v1/billing/x-pricing | Get X API pricing table
...
*WhatsAppApi* | [**verifyWhatsAppNumber**](docs/Api/WhatsAppApi.md#verifywhatsappnumber) | **POST** /v1/accounts/{accountId}/whatsapp/verify-code | Verify the Meta re-verification code for a BYO WhatsApp number
...
- [AdAnalyticsResponseAnalytics](docs/Model/AdAnalyticsResponseAnalytics.md)
...
- [AdKeyword](docs/Model/AdKeyword.md)
- [AdKeywordMetrics](docs/Model/AdKeywordMetrics.md)
- [AdKeywordQuality](docs/Model/AdKeywordQuality.md)
- [AdMetrics](docs/Model/AdMetrics.md)
- [AdNegativeKeywordList](docs/Model/AdNegativeKeywordList.md)
- [AdNegativeKeywordListKeyword](docs/Model/AdNegativeKeywordListKeyword.md)
...
- [AdScheduleWindow](docs/Model/AdScheduleWindow.md)
- [AdStatus](docs/Model/AdStatus.md)
- [AdTracking](docs/Model/AdTracking.md)
...
- [AddAccountCallouts201Response](docs/Model/AddAccountCallouts201Response.md)
- [AddAccountCallouts201ResponseCalloutsInner](docs/Model/AddAccountCallouts201ResponseCalloutsInner.md)
- [AddAccountCalloutsRequest](docs/Model/AddAccountCalloutsRequest.md)
- [AddAccountSitelinks201Response](docs/Model/AddAccountSitelinks201Response.md)
- [AddAccountSitelinks201ResponseSitelinksInner](docs/Model/AddAccountSitelinks201ResponseSitelinksInner.md)
- [AddAccountSitelinksRequest](docs/Model/AddAccountSitelinksRequest.md)
- [AddAccountStructuredSnippets201Response](docs/Model/AddAccountStructuredSnippets201Response.md)
- [AddAccountStructuredSnippets201ResponseStructuredSnippetsInner](docs/Model/AddAccountStructuredSnippets201ResponseStructuredSnippetsInner.md)
- [AddAccountStructuredSnippetsRequest](docs/Model/AddAccountStructuredSnippetsRequest.md)
- [AddAdKeywords201Response](docs/Model/AddAdKeywords201Response.md)
- [AddAdKeywordsRequest](docs/Model/AddAdKeywordsRequest.md)
- [AddAdKeywordsRequestKeywordsInner](docs/Model/AddAdKeywordsRequestKeywordsInner.md)
- [AddAdKeywordsRequestKeywordsInnerAnyOf](docs/Model/AddAdKeywordsRequestKeywordsInnerAnyOf.md)
...
- [ApiKeyCreatedBy](docs/Model/ApiKeyCreatedBy.md)
...
- [BoostPostRequestAttributionSpecInner](docs/Model/BoostPostRequestAttributionSpecInner.md)
...
- [BoostPostRequestPromoCodesInner](docs/Model/BoostPostRequestPromoCodesInner.md)
- [BoostPostRequestPromotedObject](docs/Model/BoostPostRequestPromotedObject.md)
- [BoostPostRequestSchedule](docs/Model/BoostPostRequestSchedule.md)
- [BoostPostRequestSparkPostsInner](docs/Model/BoostPostRequestSparkPostsInner.md)
...
- [BusinessAgentAllowlistEntry](docs/Model/BusinessAgentAllowlistEntry.md)
- [BusinessAgentApiKeyConfig](docs/Model/BusinessAgentApiKeyConfig.md)
- [BusinessAgentApiKeyParamsInner](docs/Model/BusinessAgentApiKeyParamsInner.md)
- [BusinessAgentBudget](docs/Model/BusinessAgentBudget.md)
- [BusinessAgentBusinessInformation](docs/Model/BusinessAgentBusinessInformation.md)
- [BusinessAgentBusinessInformationContactInfo](docs/Model/BusinessAgentBusinessInformationContactInfo.md)
- [BusinessAgentConnector](docs/Model/BusinessAgentConnector.md)
- [BusinessAgentConnectorAllOfConnectionStatus](docs/Model/BusinessAgentConnectorAllOfConnectionStatus.md)
- [BusinessAgentConnectorInput](docs/Model/BusinessAgentConnectorInput.md)
- [BusinessAgentConnectorInputAuthConfig](docs/Model/BusinessAgentConnectorInputAuthConfig.md)
- [BusinessAgentConnectorInputUserAuthInjectionConfig](docs/Model/BusinessAgentConnectorInputUserAuthInjectionConfig.md)
- [BusinessAgentConnectorTool](docs/Model/BusinessAgentConnectorTool.md)
- [BusinessAgentConnectorToolInput](docs/Model/BusinessAgentConnectorToolInput.md)
- [BusinessAgentEventStatus](docs/Model/BusinessAgentEventStatus.md)
- [BusinessAgentFaq](docs/Model/BusinessAgentFaq.md)
- [BusinessAgentFaqInput](docs/Model/BusinessAgentFaqInput.md)
- [BusinessAgentKnowledgeFile](docs/Model/BusinessAgentKnowledgeFile.md)
- [BusinessAgentOAuthClientCredentials](docs/Model/BusinessAgentOAuthClientCredentials.md)
- [BusinessAgentSettings](docs/Model/BusinessAgentSettings.md)
- [BusinessAgentSettingsFollowup](docs/Model/BusinessAgentSettingsFollowup.md)
- [BusinessAgentSettingsHandoff](docs/Model/BusinessAgentSettingsHandoff.md)
- [BusinessAgentSettingsRollout](docs/Model/BusinessAgentSettingsRollout.md)
- [BusinessAgentSkill](docs/Model/BusinessAgentSkill.md)
- [BusinessAgentSkillInput](docs/Model/BusinessAgentSkillInput.md)
- [BusinessAgentStatus](docs/Model/BusinessAgentStatus.md)
- [BusinessAgentStatusManualStepsInner](docs/Model/BusinessAgentStatusManualStepsInner.md)
- [BusinessAgentStatusUnverifiedStepsInner](docs/Model/BusinessAgentStatusUnverifiedStepsInner.md)
- [BusinessAgentTestMessageResponse](docs/Model/BusinessAgentTestMessageResponse.md)
- [BusinessAgentUiSkill](docs/Model/BusinessAgentUiSkill.md)
- [BusinessAgentUiSkillInput](docs/Model/BusinessAgentUiSkillInput.md)
- [BusinessAgentWebsite](docs/Model/BusinessAgentWebsite.md)
- [BusinessAgentWebsiteInput](docs/Model/BusinessAgentWebsiteInput.md)
...
- [CampaignAnalyticsResponseAnalyticsImpressionShareCache](docs/Model/CampaignAnalyticsResponseAnalyticsImpressionShareCache.md)
- [CampaignAnalyticsResponseAnalyticsSummary](docs/Model/CampaignAnalyticsResponseAnalyticsSummary.md)
...
- [ConversionAction](docs/Model/ConversionAction.md)
- [ConversionActionTagSnippetsInner](docs/Model/ConversionActionTagSnippetsInner.md)
...
- [CreateConversionAction201Response](docs/Model/CreateConversionAction201Response.md)
- [CreateConversionActionRequest](docs/Model/CreateConversionActionRequest.md)
...
- [CreateImessageGroup202Response](docs/Model/CreateImessageGroup202Response.md)
- [CreateImessageGroupRequest](docs/Model/CreateImessageGroupRequest.md)
- [CreateImessageOptInLink200Response](docs/Model/CreateImessageOptInLink200Response.md)
- [CreateImessageOptInLink200ResponseLink](docs/Model/CreateImessageOptInLink200ResponseLink.md)
- [CreateImessageOptInLinkRequest](docs/Model/CreateImessageOptInLinkRequest.md)
...
- [CreateInboxConversation400ResponseAnyOf](docs/Model/CreateInboxConversation400ResponseAnyOf.md)
- [CreateInboxConversation404Response](docs/Model/CreateInboxConversation404Response.md)
- [CreateInboxConversation404ResponseAnyOf](docs/Model/CreateInboxConversation404ResponseAnyOf.md)
- [CreateInboxConversation409Response](docs/Model/CreateInboxConversation409Response.md)
- [CreateInboxConversation422Response](docs/Model/CreateInboxConversation422Response.md)
- [CreateInboxConversation422ResponseAnyOf](docs/Model/CreateInboxConversation422ResponseAnyOf.md)
- [CreateInboxConversation429Response](docs/Model/CreateInboxConversation429Response.md)
- [CreateInboxConversation429ResponseAnyOf](docs/Model/CreateInboxConversation429ResponseAnyOf.md)
...
- [CreateInboxConversationRequestTemplateCardsInner](docs/Model/CreateInboxConversationRequestTemplateCardsInner.md)
- [CreateInboxConversationRequestTemplateCardsInnerButtonsInner](docs/Model/CreateInboxConversationRequestTemplateCardsInnerButtonsInner.md)
- [CreateInboxConversationRequestTemplateCardsInnerHeaderMedia](docs/Model/CreateInboxConversationRequestTemplateCardsInnerHeaderMedia.md)
...
- [CreateMessagingAd201Response](docs/Model/CreateMessagingAd201Response.md)
...
- [CreatePost200Response](docs/Model/CreatePost200Response.md)
...
- [CreateStandaloneAdRequestAdditionalDescriptionsInner](docs/Model/CreateStandaloneAdRequestAdditionalDescriptionsInner.md)
- [CreateStandaloneAdRequestAdditionalHeadlinesInner](docs/Model/CreateStandaloneAdRequestAdditionalHeadlinesInner.md)
...
- [CreateStandaloneAdRequestCitiesInnerOneOf](docs/Model/CreateStandaloneAdRequestCitiesInnerOneOf.md)
...
- [CreateStandaloneAdRequestRegionsInnerOneOf](docs/Model/CreateStandaloneAdRequestRegionsInnerOneOf.md)
...
- [CtwaAdRequestBodyWelcomeMessageQuickRepliesInner](docs/Model/CtwaAdRequestBodyWelcomeMessageQuickRepliesInner.md)
...
- [ErrorResponseDetails](docs/Model/ErrorResponseDetails.md)
- [ErrorResponseDetailsCreatedObjectsInner](docs/Model/ErrorResponseDetailsCreatedObjectsInner.md)
- [ErrorResponseDetailsUnconfirmedWrite](docs/Model/ErrorResponseDetailsUnconfirmedWrite.md)
...
- [GetAdNegativeKeywordList200Response](docs/Model/GetAdNegativeKeywordList200Response.md)
- [GetAdNegativeKeywordList200ResponseList](docs/Model/GetAdNegativeKeywordList200ResponseList.md)
...
- [GetCampaignAdSchedule200Response](docs/Model/GetCampaignAdSchedule200Response.md)
- [GetCampaignAdSchedule200ResponsePerformance](docs/Model/GetCampaignAdSchedule200ResponsePerformance.md)
- [GetCampaignAdSchedule200ResponsePerformanceByDayOfWeekInner](docs/Model/GetCampaignAdSchedule200ResponsePerformanceByDayOfWeekInner.md)
...
- [GetImessageGroup200Response](docs/Model/GetImessageGroup200Response.md)
- [GetImessageGroup200ResponseGroup](docs/Model/GetImessageGroup200ResponseGroup.md)
- [GetImessageSender200Response](docs/Model/GetImessageSender200Response.md)
- [GetImessageSender200ResponseHealth](docs/Model/GetImessageSender200ResponseHealth.md)
...
- [GetInboxConversationMessages200ResponseMessagesInnerStoryReply](docs/Model/GetInboxConversationMessages200ResponseMessagesInnerStoryReply.md)
...
- [GetIosFourteenCampaignLimits200Response](docs/Model/GetIosFourteenCampaignLimits200Response.md)
- [GetIosFourteenCampaignLimits200ResponseLimits](docs/Model/GetIosFourteenCampaignLimits200ResponseLimits.md)
- [GetLeadForm200Response](docs/Model/GetLeadForm200Response.md)
- [GetLeadForm200ResponseForm](docs/Model/GetLeadForm200ResponseForm.md)
...
- [GetPhoneNumberClaim200Response](docs/Model/GetPhoneNumberClaim200Response.md)
- [GetPhoneNumberClaim200ResponseArea](docs/Model/GetPhoneNumberClaim200ResponseArea.md)
- [GetPhoneNumberClaim200ResponseCountry](docs/Model/GetPhoneNumberClaim200ResponseCountry.md)
...
- [GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettings](docs/Model/GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettings.md)
- [GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettingsAllowComment](docs/Model/GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettingsAllowComment.md)
- [GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettingsAllowDuet](docs/Model/GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettingsAllowDuet.md)
- [GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettingsAllowStitch](docs/Model/GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettingsAllowStitch.md)
- [GetTikTokCreatorInfo200ResponsePrivacyLevelsInner](docs/Model/GetTikTokCreatorInfo200ResponsePrivacyLevelsInner.md)
- [GetTikTokSmartPlusMaterialReport200Response](docs/Model/GetTikTokSmartPlusMaterialReport200Response.md)
- [GetTikTokSmartPlusMaterialReport200ResponseRowsInner](docs/Model/GetTikTokSmartPlusMaterialReport200ResponseRowsInner.md)
- [GetTikTokSmartPlusMaterialReport200ResponseRowsInnerMetrics](docs/Model/GetTikTokSmartPlusMaterialReport200ResponseRowsInnerMetrics.md)
...
- [InboxWebhookConversationDetail](docs/Model/InboxWebhookConversationDetail.md)
...
- [InlineObject4Details](docs/Model/InlineObject4Details.md)
...
- [LinkedInPlatformDataAudience](docs/Model/LinkedInPlatformDataAudience.md)
- [LinkedInPlatformDataAudienceInterfaceLocalesInner](docs/Model/LinkedInPlatformDataAudienceInterfaceLocalesInner.md)
- [LinkedInPlatformDataPoll](docs/Model/LinkedInPlatformDataPoll.md)
- [ListAccountCallouts200Response](docs/Model/ListAccountCallouts200Response.md)
- [ListAccountCallouts200ResponseCalloutsInner](docs/Model/ListAccountCallouts200ResponseCalloutsInner.md)
...
- [ListAccountSitelinks200Response](docs/Model/ListAccountSitelinks200Response.md)
...
- [ListAdGroupAssets200ResponseSitelinksInner](docs/Model/ListAdGroupAssets200ResponseSitelinksInner.md)
- [ListAdGroupAssets200ResponseStructuredSnippetsInner](docs/Model/ListAdGroupAssets200ResponseStructuredSnippetsInner.md)
...
- [ListAdSets200ResponseAdSetsInnerBudget](docs/Model/ListAdSets200ResponseAdSetsInnerBudget.md)
- [ListAdSets200ResponseAdSetsInnerSchedule](docs/Model/ListAdSets200ResponseAdSetsInnerSchedule.md)
- [ListAdSets200ResponseAdSetsInnerTargeting](docs/Model/ListAdSets200ResponseAdSetsInnerTargeting.md)
...
- [ListAdsInstagramAccounts200Response](docs/Model/ListAdsInstagramAccounts200Response.md)
- [ListAdsInstagramAccounts200ResponseAccountsInner](docs/Model/ListAdsInstagramAccounts200ResponseAccountsInner.md)
- [ListAdsInstagramAccounts200ResponsePagesInner](docs/Model/ListAdsInstagramAccounts200ResponsePagesInner.md)
- [ListAdsInstagramAccounts200ResponseResolved](docs/Model/ListAdsInstagramAccounts200ResponseResolved.md)
- [ListAdsInstagramPosts200Response](docs/Model/ListAdsInstagramPosts200Response.md)
- [ListAdsInstagramPosts200ResponsePaging](docs/Model/ListAdsInstagramPosts200ResponsePaging.md)
- [ListAdsInstagramPosts200ResponsePostsInner](docs/Model/ListAdsInstagramPosts200ResponsePostsInner.md)
- [ListAdsTikTokIdentities200Response](docs/Model/ListAdsTikTokIdentities200Response.md)
- [ListAdsTikTokIdentities200ResponseIdentitiesInner](docs/Model/ListAdsTikTokIdentities200ResponseIdentitiesInner.md)
- [ListAdvertisableApplications200Response](docs/Model/ListAdvertisableApplications200Response.md)
- [ListAdvertisableApplications200ResponseApplicationsInner](docs/Model/ListAdvertisableApplications200ResponseApplicationsInner.md)
...
- [ListBusinessAgentAllowlist200Response](docs/Model/ListBusinessAgentAllowlist200Response.md)
- [ListBusinessAgentConnectorTools200Response](docs/Model/ListBusinessAgentConnectorTools200Response.md)
- [ListBusinessAgentConnectors200Response](docs/Model/ListBusinessAgentConnectors200Response.md)
- [ListBusinessAgentFaqs200Response](docs/Model/ListBusinessAgentFaqs200Response.md)
- [ListBusinessAgentFiles200Response](docs/Model/ListBusinessAgentFiles200Response.md)
- [ListBusinessAgentSettings200Response](docs/Model/ListBusinessAgentSettings200Response.md)
...
- [ListCampaignAssets200ResponseCalloutsInner](docs/Model/ListCampaignAssets200ResponseCalloutsInner.md)
- [ListCampaignAssets200ResponseSitelinksInner](docs/Model/ListCampaignAssets200ResponseSitelinksInner.md)
- [ListCampaignAssets200ResponseStructuredSnippetsInner](docs/Model/ListCampaignAssets200ResponseStructuredSnippetsInner.md)
- [ListCampaignNegativeKeywords200Response](docs/Model/ListCampaignNegativeKeywords200Response.md)
- [ListCampaignNegativeKeywords200ResponseKeywordsInner](docs/Model/ListCampaignNegativeKeywords200ResponseKeywordsInner.md)
...
- [ListConversionActions200Response](docs/Model/ListConversionActions200Response.md)
...
- [ListGoogleAssetGroups200Response](docs/Model/ListGoogleAssetGroups200Response.md)
...
- [ListPartnershipAdPermissions200ResponsePermissionsInner](docs/Model/ListPartnershipAdPermissions200ResponsePermissionsInner.md)
...
- [ListSlackChannels200Response](docs/Model/ListSlackChannels200Response.md)
...
- [ListTikTokAdPixels200Response](docs/Model/ListTikTokAdPixels200Response.md)
- [ListTikTokAdPixels200ResponsePixelsInner](docs/Model/ListTikTokAdPixels200ResponsePixelsInner.md)
- [ListTikTokAdPixels200ResponsePixelsInnerEventDetailsInner](docs/Model/ListTikTokAdPixels200ResponsePixelsInnerEventDetailsInner.md)
...
- [MetaLeadFormLegalContent](docs/Model/MetaLeadFormLegalContent.md)
- [MetaLeadFormLegalContentPrivacyPolicy](docs/Model/MetaLeadFormLegalContentPrivacyPolicy.md)
...
- [OnSmsRegistrationStatusUpdatedRequestRegistration](docs/Model/OnSmsRegistrationStatusUpdatedRequestRegistration.md)
...
- [OnboardBusinessAgent201Response](docs/Model/OnboardBusinessAgent201Response.md)
- [OrderImessageSender202Response](docs/Model/OrderImessageSender202Response.md)
- [OrderImessageSenderRequest](docs/Model/OrderImessageSenderRequest.md)
- [OrderImessageSenderRequestContact](docs/Model/OrderImessageSenderRequestContact.md)
- [OwnedPhoneNumber](docs/Model/OwnedPhoneNumber.md)
- [OwnedPhoneNumberFeatures](docs/Model/OwnedPhoneNumberFeatures.md)
- [OwnedPhoneNumberProfileId](docs/Model/OwnedPhoneNumberProfileId.md)
- [OwnedPhoneNumberProfileIdOneOf](docs/Model/OwnedPhoneNumberProfileIdOneOf.md)
...
- [PostPlatformError](docs/Model/PostPlatformError.md)
- [PostPublishIncompleteResponse](docs/Model/PostPublishIncompleteResponse.md)
- [PostPublishIncompleteResponsePlatformResultsInner](docs/Model/PostPublishIncompleteResponsePlatformResultsInner.md)
...
- [PurchasePhoneNumber401Response](docs/Model/PurchasePhoneNumber401Response.md)
- [PurchasePhoneNumber401ResponseDetails](docs/Model/PurchasePhoneNumber401ResponseDetails.md)
- [PurchasePhoneNumber409Response](docs/Model/PurchasePhoneNumber409Response.md)
- [PurchasePhoneNumber503Response](docs/Model/PurchasePhoneNumber503Response.md)
...
- [RegisterImessageSender200Response](docs/Model/RegisterImessageSender200Response.md)
- [RegisterImessageSenderRequest](docs/Model/RegisterImessageSenderRequest.md)
...
- [ReplaceAdNegativeKeywordListKeywords200Response](docs/Model/ReplaceAdNegativeKeywordListKeywords200Response.md)
- [ReplaceAdNegativeKeywordListKeywordsRequest](docs/Model/ReplaceAdNegativeKeywordListKeywordsRequest.md)
...
- [RespondToSmsRegistrationReviewRequestAnswersInner](docs/Model/RespondToSmsRegistrationReviewRequestAnswersInner.md)
...
- [ResyncPageWebhookSubscription200Response](docs/Model/ResyncPageWebhookSubscription200Response.md)
- [RetryPost207Response](docs/Model/RetryPost207Response.md)
...
- [RunBusinessAgentConnectorTool200Response](docs/Model/RunBusinessAgentConnectorTool200Response.md)
- [RunBusinessAgentConnectorToolRequest](docs/Model/RunBusinessAgentConnectorToolRequest.md)
...
- [SearchTikTokLocations200Response](docs/Model/SearchTikTokLocations200Response.md)
- [SearchTikTokLocations200ResponseLocationsInner](docs/Model/SearchTikTokLocations200ResponseLocationsInner.md)
...
- [SelectFacebookPageRequestOneOf](docs/Model/SelectFacebookPageRequestOneOf.md)
- [SelectFacebookPageRequestOneOf1](docs/Model/SelectFacebookPageRequestOneOf1.md)
- [SelectFacebookPageRequestOneOfNot](docs/Model/SelectFacebookPageRequestOneOfNot.md)
- [SelectFacebookPageRequestOneOfUserProfile](docs/Model/SelectFacebookPageRequestOneOfUserProfile.md)
...
- [SendBusinessAgentEvent202Response](docs/Model/SendBusinessAgentEvent202Response.md)
- [SendBusinessAgentEventRequest](docs/Model/SendBusinessAgentEventRequest.md)
- [SendBusinessAgentTestMessageRequest](docs/Model/SendBusinessAgentTestMessageRequest.md)
...
- [SendInboxMessage429Response](docs/Model/SendInboxMessage429Response.md)
...
- [SetBusinessAgentConnectorCredentialsRequest](docs/Model/SetBusinessAgentConnectorCredentialsRequest.md)
- [SetBusinessAgentConnectorCredentialsRequestOneOf](docs/Model/SetBusinessAgentConnectorCredentialsRequestOneOf.md)
...
- [SetConversationThreadControlRequest](docs/Model/SetConversationThreadControlRequest.md)
- [SetImessageSubscription200Response](docs/Model/SetImessageSubscription200Response.md)
- [SetImessageSubscriptionRequest](docs/Model/SetImessageSubscriptionRequest.md)
...
- [SmsRegistrationReviewRequest](docs/Model/SmsRegistrationReviewRequest.md)
- [SmsRegistrationReviewRequestPointsInner](docs/Model/SmsRegistrationReviewRequestPointsInner.md)
...
- [StartBusinessAgentEvalRun202Response](docs/Model/StartBusinessAgentEvalRun202Response.md)
- [StartBusinessAgentEvalRunRequest](docs/Model/StartBusinessAgentEvalRunRequest.md)
...
- [StartOAuth](docs/Model/StartOAuth.md)
...
- [TargetingSpecCitiesInnerOneOf](docs/Model/TargetingSpecCitiesInnerOneOf.md)
...
- [TikTokDryRunVerdict](docs/Model/TikTokDryRunVerdict.md)
- [TikTokDryRunVerdictTiktokInner](docs/Model/TikTokDryRunVerdictTiktokInner.md)
...
- [UpdateAccountCallouts200Response](docs/Model/UpdateAccountCallouts200Response.md)
- [UpdateAccountCalloutsRequest](docs/Model/UpdateAccountCalloutsRequest.md)
- [UpdateAccountCalloutsRequestUpdatesInner](docs/Model/UpdateAccountCalloutsRequestUpdatesInner.md)
- [UpdateAccountCalloutsRequestUpdatesInnerCalloutAsset](docs/Model/UpdateAccountCalloutsRequestUpdatesInnerCalloutAsset.md)
...
- [UpdateAccountSitelinksRequest](docs/Model/UpdateAccountSitelinksRequest.md)
- [UpdateAccountSitelinksRequestUpdatesInner](docs/Model/UpdateAccountSitelinksRequestUpdatesInner.md)
- [UpdateAccountSitelinksRequestUpdatesInnerSitelinkAsset](docs/Model/UpdateAccountSitelinksRequestUpdatesInnerSitelinkAsset.md)
- [UpdateAccountStructuredSnippetsRequest](docs/Model/UpdateAccountStructuredSnippetsRequest.md)
- [UpdateAccountStructuredSnippetsRequestUpdatesInner](docs/Model/UpdateAccountStructuredSnippetsRequestUpdatesInner.md)
...
- [UpdateAdRequestTargetingLocations](docs/Model/UpdateAdRequestTargetingLocations.md)
- [UpdateAdRequestTargetingLocationsOneOf](docs/Model/UpdateAdRequestTargetingLocationsOneOf.md)
...
- [UpdateAdTrackingTags200Response](docs/Model/UpdateAdTrackingTags200Response.md)
...
- [UpdateBusinessAgentSettingsRequest](docs/Model/UpdateBusinessAgentSettingsRequest.md)
- [UpdateBusinessAgentSettingsRequestFollowup](docs/Model/UpdateBusinessAgentSettingsRequestFollowup.md)
- [UpdateBusinessAgentSettingsRequestHandoff](docs/Model/UpdateBusinessAgentSettingsRequestHandoff.md)
- [UpdateBusinessAgentSettingsRequestRollout](docs/Model/UpdateBusinessAgentSettingsRequestRollout.md)
- [UpdateCampaignAdSchedule200Response](docs/Model/UpdateCampaignAdSchedule200Response.md)
- [UpdateCampaignAdScheduleRequest](docs/Model/UpdateCampaignAdScheduleRequest.md)
...
- [UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf](docs/Model/UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf.md)
...
- [UpdateGoogleBusinessLocationDetailsRequestAdWordsLocationExtensions](docs/Model/UpdateGoogleBusinessLocationDetailsRequestAdWordsLocationExtensions.md)
...
- [UpdateGoogleBusinessLocationDetailsRequestLatlng](docs/Model/UpdateGoogleBusinessLocationDetailsRequestLatlng.md)
- [UpdateGoogleBusinessLocationDetailsRequestMoreHoursInner](docs/Model/UpdateGoogleBusinessLocationDetailsRequestMoreHoursInner.md)
- [UpdateGoogleBusinessLocationDetailsRequestOpenInfo](docs/Model/UpdateGoogleBusinessLocationDetailsRequestOpenInfo.md)
...
- [UpdateGoogleBusinessLocationDetailsRequestServiceArea](docs/Model/UpdateGoogleBusinessLocationDetailsRequestServiceArea.md)
- [UpdateGoogleBusinessLocationDetailsRequestServiceAreaPlaces](docs/Model/UpdateGoogleBusinessLocationDetailsRequestServiceAreaPlaces.md)
- [UpdateGoogleBusinessLocationDetailsRequestServiceAreaPlacesPlaceInfosInner](docs/Model/UpdateGoogleBusinessLocationDetailsRequestServiceAreaPlacesPlaceInfosInner.md)
...
- [UpdateGoogleBusinessLocationDetailsRequestStorefrontAddress](docs/Model/UpdateGoogleBusinessLocationDetailsRequestStorefrontAddress.md)
...
- [UpdateImessageGroup200Response](docs/Model/UpdateImessageGroup200Response.md)
- [UpdateImessageGroupRequest](docs/Model/UpdateImessageGroupRequest.md)
- [UpdateImessageSenderRequest](docs/Model/UpdateImessageSenderRequest.md)
- [UpdateImessageSenderRequestContact](docs/Model/UpdateImessageSenderRequestContact.md)
...
- [UpdateProductRequestSeo](docs/Model/UpdateProductRequestSeo.md)
- [UpdateProductRequestVariantsInner](docs/Model/UpdateProductRequestVariantsInner.md)
- [UpdateProductRequestVariantsInnerCompareAtPrice](docs/Model/UpdateProductRequestVariantsInnerCompareAtPrice.md)
...
- [UploadBusinessAgentFileRequest](docs/Model/UploadBusinessAgentFileRequest.md)
...
- [VerifyWhatsAppNumber200Response](docs/Model/VerifyWhatsAppNumber200Response.md)
- [VerifyWhatsAppNumberRequest](docs/Model/VerifyWhatsAppNumberRequest.md)
...
- [WebhookPayloadMessageMetadataLocation](docs/Model/WebhookPayloadMessageMetadataLocation.md)
...
- [WebhookPayloadMessageSentMetadataLocation](docs/Model/WebhookPayloadMessageSentMetadataLocation.md)
...
- [WhatsAppTemplateLookupError](docs/Model/WhatsAppTemplateLookupError.md)
- [WhatsAppTemplateLookupErrorDetails](docs/Model/WhatsAppTemplateLookupErrorDetails.md)
- [WhatsAppTemplateLookupErrorDetailsProviderHeaders](docs/Model/WhatsAppTemplateLookupErrorDetailsProviderHeaders.md)
- [WhatsAppTemplateLookupErrorPlatformError](docs/Model/WhatsAppTemplateLookupErrorPlatformError.md)
- [WhatsAppTemplateLookupErrorPlatformErrorErrorData](docs/Model/WhatsAppTemplateLookupErrorPlatformErrorErrorData.md)
