...
class AdsApi
{
    ...
    public function listMetaBusinessesRequest($account_id, $limit = 25, $after = null, string $contentType = self::contentTypes['listMetaBusinesses'][0])
    {
        ...
        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AdsApi.listMetaBusinesses, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AdsApi.listMetaBusinesses, must be bigger than or equal to 1.');
        }
