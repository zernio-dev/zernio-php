...
class APIKeysApi
{
     ...
     * Verify credential
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['verifyCredential'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->verifyCredentialWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation verifyCredentialWithHttpInfo
     *
     * Verify credential
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['verifyCredential'] to see the possible values for this operation
    ...
    {
        $request = $this->verifyCredentialRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\VerifyCredential200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation verifyCredentialAsync
     *
     * Verify credential
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['verifyCredential'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function verifyCredentialAsync(string $contentType = self::contentTypes['verifyCredential'][0])
    {
        return $this->verifyCredentialAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation verifyCredentialAsyncWithHttpInfo
     *
     * Verify credential
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['verifyCredential'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function verifyCredentialAsyncWithHttpInfo(string $contentType = self::contentTypes['verifyCredential'][0])
    {
        $returnType = '\Zernio\Model\VerifyCredential200Response';
        $request = $this->verifyCredentialRequest($contentType);
    ...
    /**
     * Create request for operation 'verifyCredential'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['verifyCredential'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function verifyCredentialRequest(string $contentType = self::contentTypes['verifyCredential'][0])
    {


        $resourcePath = '/v1/auth/verify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
