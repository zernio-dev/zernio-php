...
class CommentsApi
{
     ...
     * Delete comment
     *
     * @param  string $post_id Late post ID or platform-specific post ID. LinkedIn third-party posts accept full activity URN or numeric ID. (required)
     ...
     * Get post comments
     *
     * @param  string $post_id Late post ID or platform-specific post ID. Late IDs are auto-resolved. LinkedIn third-party posts accept full activity URN or numeric ID. (required)
     * @param  string $account_id account_id (required)
     ...
     *
     * @param  string $post_id Late post ID or platform-specific post ID (LinkedIn activity URN or numeric ID). (required)
     * @param  string $account_id The social account ID (must be a LinkedIn organization account). (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPostReactions'] to see the possible values for this operation
     *
     * @throws \Late\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Late\Model\GetPostReactions200Response|\Late\Model\SendInboxMessage400Response|\Late\Model\InlineObject
     */
    public function getPostReactions($post_id, $account_id, $limit = 25, $cursor = null, string $contentType = self::contentTypes['getPostReactions'][0])
    {
        list($response) = $this->getPostReactionsWithHttpInfo($post_id, $account_id, $limit, $cursor, $contentType);
        return $response;
    }

    /**
     * Operation getPostReactionsWithHttpInfo
     *
     * Get post reactions (who reacted)
     *
     * @param  string $post_id Late post ID or platform-specific post ID (LinkedIn activity URN or numeric ID). (required)
     ...
     * @throws \Late\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Late\Model\GetPostReactions200Response|\Late\Model\SendInboxMessage400Response|\Late\Model\InlineObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPostReactionsWithHttpInfo($post_id, $account_id, $limit = 25, $cursor = null, string $contentType = self::contentTypes['getPostReactions'][0])
    {
        $request = $this->getPostReactionsRequest($post_id, $account_id, $limit, $cursor, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Late\Model\GetPostReactions200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation getPostReactionsAsync
     *
     * Get post reactions (who reacted)
     *
     * @param  string $post_id Late post ID or platform-specific post ID (LinkedIn activity URN or numeric ID). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPostReactionsAsync($post_id, $account_id, $limit = 25, $cursor = null, string $contentType = self::contentTypes['getPostReactions'][0])
    {
        return $this->getPostReactionsAsyncWithHttpInfo($post_id, $account_id, $limit, $cursor, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPostReactionsAsyncWithHttpInfo
     *
     * Get post reactions (who reacted)
     *
     * @param  string $post_id Late post ID or platform-specific post ID (LinkedIn activity URN or numeric ID). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPostReactionsAsyncWithHttpInfo($post_id, $account_id, $limit = 25, $cursor = null, string $contentType = self::contentTypes['getPostReactions'][0])
    {
        $returnType = '\Late\Model\GetPostReactions200Response';
        $request = $this->getPostReactionsRequest($post_id, $account_id, $limit, $cursor, $contentType);
    ...
    /**
     * Create request for operation 'getPostReactions'
     *
     * @param  string $post_id Late post ID or platform-specific post ID (LinkedIn activity URN or numeric ID). (required)
     * @param  string $account_id The social account ID (must be a LinkedIn organization account). (required)
     * @param  int|null $limit Maximum number of reactions to return per page. (optional, default to 25)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPostReactionsRequest($post_id, $account_id, $limit = 25, $cursor = null, string $contentType = self::contentTypes['getPostReactions'][0])
    {

        // verify the required parameter 'post_id' is set
        if ($post_id === null || (is_array($post_id) && count($post_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_id when calling getPostReactions'
            );
        }
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling getPostReactions'
            );
        }

        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling CommentsApi.getPostReactions, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling CommentsApi.getPostReactions, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v1/inbox/reactions/{postId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
