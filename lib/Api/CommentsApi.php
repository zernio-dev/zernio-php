...
class CommentsApi
{
     ...
     * @param  string|null $comment_id (Facebook, Instagram, Reddit and TikTok) Get replies to a specific comment. On Facebook and Instagram, the requested comment is returned in the top-level &#x60;comment&#x60; field and comments[] holds its replies. (optional)
     ...
     * Like post
     *
     * @param  string $post_id Zernio post ID or the platform&#39;s native post ID (required)
     * @param  \Zernio\Model\LikePostRequest $like_post_request like_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['likePost'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->likePostWithHttpInfo($post_id, $like_post_request, $contentType);
        return $response;
    }

    /**
     * Operation likePostWithHttpInfo
     *
     * Like post
     *
     * @param  string $post_id Zernio post ID or the platform&#39;s native post ID (required)
     * @param  \Zernio\Model\LikePostRequest $like_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['likePost'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        $request = $this->likePostRequest($post_id, $like_post_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\LikePost200Response',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function likePostAsync($post_id, $like_post_request, string $contentType = self::contentTypes['likePost'][0])
    {
        return $this->likePostAsyncWithHttpInfo($post_id, $like_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation likePostAsyncWithHttpInfo
     *
     * Like post
     *
     * @param  string $post_id Zernio post ID or the platform&#39;s native post ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function likePostAsyncWithHttpInfo($post_id, $like_post_request, string $contentType = self::contentTypes['likePost'][0])
    {
        $returnType = '\Zernio\Model\LikePost200Response';
        $request = $this->likePostRequest($post_id, $like_post_request, $contentType);
    ...
    /**
     * Create request for operation 'likePost'
     *
     * @param  string $post_id Zernio post ID or the platform&#39;s native post ID (required)
     * @param  \Zernio\Model\LikePostRequest $like_post_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['likePost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function likePostRequest($post_id, $like_post_request, string $contentType = self::contentTypes['likePost'][0])
    {

        // verify the required parameter 'post_id' is set
        if ($post_id === null || (is_array($post_id) && count($post_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_id when calling likePost'
            );
        }

        // verify the required parameter 'like_post_request' is set
        if ($like_post_request === null || (is_array($like_post_request) && count($like_post_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $like_post_request when calling likePost'
            );
        }


        $resourcePath = '/v1/inbox/posts/{postId}/like';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($like_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($like_post_request));
            } else {
                $httpBody = $like_post_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  int|null $min_comments Minimum comment count, applied to each page after pagination (optional)
    ...
    /**
     * Operation pinInboxComment
     *
     * Pin comment
     *
     * @param  string $post_id post_id (required)
     * @param  string $comment_id comment_id (required)
     * @param  \Zernio\Model\PinInboxCommentRequest $pin_inbox_comment_request pin_inbox_comment_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pinInboxComment'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\PinInboxComment200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1
     */
    public function pinInboxComment($post_id, $comment_id, $pin_inbox_comment_request, string $contentType = self::contentTypes['pinInboxComment'][0])
    {
        list($response) = $this->pinInboxCommentWithHttpInfo($post_id, $comment_id, $pin_inbox_comment_request, $contentType);
        return $response;
    }

    /**
     * Operation pinInboxCommentWithHttpInfo
     *
     * Pin comment
     *
     * @param  string $post_id (required)
     * @param  string $comment_id (required)
     * @param  \Zernio\Model\PinInboxCommentRequest $pin_inbox_comment_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pinInboxComment'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\PinInboxComment200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1, HTTP status code, HTTP response headers (array of strings)
     */
    public function pinInboxCommentWithHttpInfo($post_id, $comment_id, $pin_inbox_comment_request, string $contentType = self::contentTypes['pinInboxComment'][0])
    {
        $request = $this->pinInboxCommentRequest($post_id, $comment_id, $pin_inbox_comment_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\PinInboxComment200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation pinInboxCommentAsync
     *
     * Pin comment
     *
     * @param  string $post_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pinInboxCommentAsync($post_id, $comment_id, $pin_inbox_comment_request, string $contentType = self::contentTypes['pinInboxComment'][0])
    {
        return $this->pinInboxCommentAsyncWithHttpInfo($post_id, $comment_id, $pin_inbox_comment_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation pinInboxCommentAsyncWithHttpInfo
     *
     * Pin comment
     *
     * @param  string $post_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pinInboxCommentAsyncWithHttpInfo($post_id, $comment_id, $pin_inbox_comment_request, string $contentType = self::contentTypes['pinInboxComment'][0])
    {
        $returnType = '\Zernio\Model\PinInboxComment200Response';
        $request = $this->pinInboxCommentRequest($post_id, $comment_id, $pin_inbox_comment_request, $contentType);
    ...
    /**
     * Create request for operation 'pinInboxComment'
     *
     * @param  string $post_id (required)
     * @param  string $comment_id (required)
     * @param  \Zernio\Model\PinInboxCommentRequest $pin_inbox_comment_request (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pinInboxCommentRequest($post_id, $comment_id, $pin_inbox_comment_request, string $contentType = self::contentTypes['pinInboxComment'][0])
    {

        // verify the required parameter 'post_id' is set
        if ($post_id === null || (is_array($post_id) && count($post_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_id when calling pinInboxComment'
            );
        }
        ...
        if ($comment_id === null || (is_array($comment_id) && count($comment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $comment_id when calling pinInboxComment'
            );
        }

        // verify the required parameter 'pin_inbox_comment_request' is set
        if ($pin_inbox_comment_request === null || (is_array($pin_inbox_comment_request) && count($pin_inbox_comment_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pin_inbox_comment_request when calling pinInboxComment'
            );
        }


        $resourcePath = '/v1/inbox/comments/{postId}/{commentId}/pin';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($pin_inbox_comment_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($pin_inbox_comment_request));
            } else {
                $httpBody = $pin_inbox_comment_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  string $account_id account_id (required)
     * @param  string|null $like_uri (Bluesky only) The like URI returned when liking (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unlikePost'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->unlikePostWithHttpInfo($post_id, $account_id, $like_uri, $contentType);
        return $response;
    }

    /**
     * Operation unlikePostWithHttpInfo
     *
     * Unlike post
     *
     * @param  string $post_id Zernio post ID or the platform&#39;s native post ID (required)
    ...
    {
        $request = $this->unlikePostRequest($post_id, $account_id, $like_uri, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\UnlikePost200Response',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unlikePostAsync($post_id, $account_id, $like_uri = null, string $contentType = self::contentTypes['unlikePost'][0])
    {
        return $this->unlikePostAsyncWithHttpInfo($post_id, $account_id, $like_uri, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unlikePostAsyncWithHttpInfo
     *
     * Unlike post
     *
     * @param  string $post_id Zernio post ID or the platform&#39;s native post ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unlikePostAsyncWithHttpInfo($post_id, $account_id, $like_uri = null, string $contentType = self::contentTypes['unlikePost'][0])
    {
        $returnType = '\Zernio\Model\UnlikePost200Response';
        $request = $this->unlikePostRequest($post_id, $account_id, $like_uri, $contentType);
    ...
    /**
     * Create request for operation 'unlikePost'
     *
     * @param  string $post_id Zernio post ID or the platform&#39;s native post ID (required)
     * @param  string $account_id (required)
     * @param  string|null $like_uri (Bluesky only) The like URI returned when liking (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unlikePostRequest($post_id, $account_id, $like_uri = null, string $contentType = self::contentTypes['unlikePost'][0])
    {

        // verify the required parameter 'post_id' is set
        if ($post_id === null || (is_array($post_id) && count($post_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_id when calling unlikePost'
            );
        }
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling unlikePost'
            );
        }
     ...
     * @param  string $comment_id comment_id (required)
     * @param  string $account_id account_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['unpinInboxComment'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\PinInboxComment200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1
     */
    public function unpinInboxComment($post_id, $comment_id, $account_id, string $contentType = self::contentTypes['unpinInboxComment'][0])
    {
        list($response) = $this->unpinInboxCommentWithHttpInfo($post_id, $comment_id, $account_id, $contentType);
        return $response;
    }

    /**
     * Operation unpinInboxCommentWithHttpInfo
     *
     * Unpin comment
     *
     * @param  string $post_id (required)
     ...
     * @return array of \Zernio\Model\PinInboxComment200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1, HTTP status code, HTTP response headers (array of strings)
     */
    public function unpinInboxCommentWithHttpInfo($post_id, $comment_id, $account_id, string $contentType = self::contentTypes['unpinInboxComment'][0])
    {
        $request = $this->unpinInboxCommentRequest($post_id, $comment_id, $account_id, $contentType);
    ...
    /**
     * Operation unpinInboxCommentAsync
     *
     * Unpin comment
     *
     * @param  string $post_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unpinInboxCommentAsync($post_id, $comment_id, $account_id, string $contentType = self::contentTypes['unpinInboxComment'][0])
    {
        return $this->unpinInboxCommentAsyncWithHttpInfo($post_id, $comment_id, $account_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unpinInboxCommentAsyncWithHttpInfo
     *
     * Unpin comment
     *
     * @param  string $post_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unpinInboxCommentAsyncWithHttpInfo($post_id, $comment_id, $account_id, string $contentType = self::contentTypes['unpinInboxComment'][0])
    {
        $returnType = '\Zernio\Model\PinInboxComment200Response';
        $request = $this->unpinInboxCommentRequest($post_id, $comment_id, $account_id, $contentType);
    ...
    /**
     * Create request for operation 'unpinInboxComment'
     *
     * @param  string $post_id (required)
     * @param  string $comment_id (required)
     * @param  string $account_id (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unpinInboxCommentRequest($post_id, $comment_id, $account_id, string $contentType = self::contentTypes['unpinInboxComment'][0])
    {

        // verify the required parameter 'post_id' is set
        if ($post_id === null || (is_array($post_id) && count($post_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_id when calling unpinInboxComment'
            );
        }
        ...
        if ($comment_id === null || (is_array($comment_id) && count($comment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $comment_id when calling unpinInboxComment'
            );
        }
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling unpinInboxComment'
            );
        }
