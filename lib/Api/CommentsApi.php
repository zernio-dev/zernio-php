...
class CommentsApi
{
     ...
     * Get post comments
     *
     * @param  string $post_id Zernio post ID or platform-specific post ID. Zernio IDs are auto-resolved. LinkedIn third-party posts accept full activity URN or numeric ID. On Facebook, a comment ID is also accepted here and returns that comment&#39;s replies (not supported on Instagram). (required)
     * @param  string $account_id account_id (required)
     ...
     * @param  string|null $comment_id (Reddit and TikTok only) Get replies to a specific comment (optional)
