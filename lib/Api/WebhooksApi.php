...
class WebhooksApi
{
     ...
     * Delete webhook
     *
     * @param  string|null $webhook_id Webhook ID to delete, the same name the other /v1/webhooks operations use (logs, redeliver, test). Required unless the deprecated &#x60;id&#x60; is sent instead. (optional)
     * @param  string|null $id Alias of webhookId, kept for existing callers (optional) (deprecated)
     ...
     */
    public function deleteWebhookSettings($webhook_id = null, $id = null, string $contentType = self::contentTypes['deleteWebhookSettings'][0])
    {
        list($response) = $this->deleteWebhookSettingsWithHttpInfo($webhook_id, $id, $contentType);
        return $response;
    }
     ...
     */
    public function deleteWebhookSettingsWithHttpInfo($webhook_id = null, $id = null, string $contentType = self::contentTypes['deleteWebhookSettings'][0])
    {
        $request = $this->deleteWebhookSettingsRequest($webhook_id, $id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteWebhookSettingsAsync($webhook_id = null, $id = null, string $contentType = self::contentTypes['deleteWebhookSettings'][0])
    {
        return $this->deleteWebhookSettingsAsyncWithHttpInfo($webhook_id, $id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteWebhookSettingsAsyncWithHttpInfo($webhook_id = null, $id = null, string $contentType = self::contentTypes['deleteWebhookSettings'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteWebhookSettingsRequest($webhook_id = null, $id = null, string $contentType = self::contentTypes['deleteWebhookSettings'][0])
    {

        if ($webhook_id !== null && !preg_match("/^[a-fA-F0-9]{24}$/", $webhook_id)) {
            throw new \InvalidArgumentException("invalid value for \"webhook_id\" when calling WebhooksApi.deleteWebhookSettings, must conform to the pattern /^[a-fA-F0-9]{24}$/.");
        }
        
        if ($id !== null && !preg_match("/^[a-fA-F0-9]{24}$/", $id)) {
