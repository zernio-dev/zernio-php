...
class AdLibraryApi
{
     ...
     * @param  \DateTime|null $since Meta only. Earliest delivery date (YYYY-MM-DD). LinkedIn&#39;s archive does not filter by date, so it is a 400 there: filter on details.adStatistics.firstImpressionAt / latestImpressionAt instead (EU-delivered ads only). (optional)
     * @param  \DateTime|null $until Meta only. Latest delivery date (YYYY-MM-DD); a 400 on LinkedIn, see since. (optional)
     ...
     * @return \Zernio\Model\SearchAdLibrary200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\ErrorResponse
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\SearchAdLibrary200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
