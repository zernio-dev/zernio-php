...
class LeadGenApi
{
     ...
     * @return \Zernio\Model\ArchiveLeadForm200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\ArchiveLeadForm200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\CreateLeadForm200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\CreateLeadForm200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\CreateTestLead200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\CreateTestLead200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation deleteTestLead
     *
     * Delete a test lead
     *
     * @param  string $form_id form_id (required)
     * @param  string $account_id The facebook or metaads account whose Page owns the form. (required)
     * @param  string|null $lead_id The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteTestLead'] to see the possible values for this operation
     *
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\DeleteTestLead200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1
     */
    public function deleteTestLead($form_id, $account_id, $lead_id = null, string $contentType = self::contentTypes['deleteTestLead'][0])
    {
        list($response) = $this->deleteTestLeadWithHttpInfo($form_id, $account_id, $lead_id, $contentType);
        return $response;
    }

    /**
     * Operation deleteTestLeadWithHttpInfo
     *
     * Delete a test lead
     *
     * @param  string $form_id (required)
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\DeleteTestLead200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteTestLeadWithHttpInfo($form_id, $account_id, $lead_id = null, string $contentType = self::contentTypes['deleteTestLead'][0])
    {
        $request = $this->deleteTestLeadRequest($form_id, $account_id, $lead_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zernio\Model\DeleteTestLead200Response',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTestLeadAsync($form_id, $account_id, $lead_id = null, string $contentType = self::contentTypes['deleteTestLead'][0])
    {
        return $this->deleteTestLeadAsyncWithHttpInfo($form_id, $account_id, $lead_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteTestLeadAsyncWithHttpInfo
     *
     * Delete a test lead
     *
     * @param  string $form_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTestLeadAsyncWithHttpInfo($form_id, $account_id, $lead_id = null, string $contentType = self::contentTypes['deleteTestLead'][0])
    {
        $returnType = '\Zernio\Model\DeleteTestLead200Response';
        $request = $this->deleteTestLeadRequest($form_id, $account_id, $lead_id, $contentType);
    ...
    /**
     * Create request for operation 'deleteTestLead'
     *
     * @param  string $form_id (required)
     * @param  string $account_id The facebook or metaads account whose Page owns the form. (required)
     * @param  string|null $lead_id The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTestLeadRequest($form_id, $account_id, $lead_id = null, string $contentType = self::contentTypes['deleteTestLead'][0])
    {

        // verify the required parameter 'form_id' is set
        if ($form_id === null || (is_array($form_id) && count($form_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $form_id when calling deleteTestLead'
            );
        }
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling deleteTestLead'
            );
        }
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\ListFormLeads200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\ErrorResponse
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\ListFormLeads200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\ListLeadForms200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\ListLeadForms200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1, HTTP status code, HTTP response headers (array of strings)
     */
