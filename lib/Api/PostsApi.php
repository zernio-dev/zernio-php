...
class PostsApi
{
     ...
     * @return \Zernio\Model\BulkUploadResult|\Zernio\Model\BulkUploadResult|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\GetYouTubeDailyViews400Response|\Zernio\Model\ErrorResponse|\Zernio\Model\GetInboxVolume400Response
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\BulkUploadResult|\Zernio\Model\BulkUploadResult|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\GetYouTubeDailyViews400Response|\Zernio\Model\ErrorResponse|\Zernio\Model\GetInboxVolume400Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\CreatePost200Response|\Zernio\Model\PostCreateResponse|\Zernio\Model\PostPublishIncompleteResponse|\Zernio\Model\GetYouTubeDailyViews400Response|\Zernio\Model\InlineObject1|\Zernio\Model\CreatePost403Response|\Zernio\Model\CreatePost409Response|\Zernio\Model\CreatePost429Response
     */
    public function createPost($create_post_request, $idempotency_key = null, $x_request_id = null, string $contentType = self::contentTypes['createPost'][0])
    {
        list($response) = $this->createPostWithHttpInfo($create_post_request, $idempotency_key, $x_request_id, $contentType);
        return $response;
    }
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\CreatePost200Response|\Zernio\Model\PostCreateResponse|\Zernio\Model\PostPublishIncompleteResponse|\Zernio\Model\GetYouTubeDailyViews400Response|\Zernio\Model\InlineObject1|\Zernio\Model\CreatePost403Response|\Zernio\Model\CreatePost409Response|\Zernio\Model\CreatePost429Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPostWithHttpInfo($create_post_request, $idempotency_key = null, $x_request_id = null, string $contentType = self::contentTypes['createPost'][0])
    {
        $request = $this->createPostRequest($create_post_request, $idempotency_key, $x_request_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPostAsync($create_post_request, $idempotency_key = null, $x_request_id = null, string $contentType = self::contentTypes['createPost'][0])
    {
        return $this->createPostAsyncWithHttpInfo($create_post_request, $idempotency_key, $x_request_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPostAsyncWithHttpInfo($create_post_request, $idempotency_key = null, $x_request_id = null, string $contentType = self::contentTypes['createPost'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createPostRequest($create_post_request, $idempotency_key = null, $x_request_id = null, string $contentType = self::contentTypes['createPost'][0])
    {
        ...
        if ($idempotency_key !== null && strlen($idempotency_key) > 255) {
            throw new \InvalidArgumentException('invalid length for "$idempotency_key" when calling PostsApi.createPost, must be smaller than or equal to 255.');
        }
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\PostDeleteResponse|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\PostDeleteResponse|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\EditPost200Response|\Zernio\Model\InlineObject1|\Zernio\Model\InlineObject2
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\EditPost200Response|\Zernio\Model\InlineObject1|\Zernio\Model\InlineObject2, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\PostGetResponse|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\PostGetResponse|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  int|null $offset Row offset. Takes precedence over page when both are sent; the response pagination.page is derived from it. (optional)
     ...
     * @param  \DateTime|null $from_date Zero-padded YYYY-MM-DD, or a full ISO 8601 datetime. An empty value means no date filter; any other malformed value returns 400. The same name the other date-window filters use (ads, analytics). (optional)
     * @param  \DateTime|null $to_date Zero-padded YYYY-MM-DD, or a full ISO 8601 datetime. An empty value means no date filter; any other malformed value returns 400. The same name the other date-window filters use (ads, analytics). (optional)
     * @param  \DateTime|null $date_from Alias of fromDate, kept for existing callers (optional) (deprecated)
     * @param  \DateTime|null $date_to Alias of toDate, kept for existing callers (optional) (deprecated)
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\PostsListResponse|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1
     */
    public function listPosts($page = 1, $limit = 10, $offset = null, $source = 'zernio', $status = null, $platform = null, $profile_id = null, $created_by = null, $from_date = null, $to_date = null, $date_from = null, $date_to = null, $include_hidden = false, $search = null, $sort_by = 'scheduled-desc', $account_id = null, string $contentType = self::contentTypes['listPosts'][0])
    {
        list($response) = $this->listPostsWithHttpInfo($page, $limit, $offset, $source, $status, $platform, $profile_id, $created_by, $from_date, $to_date, $date_from, $date_to, $include_hidden, $search, $sort_by, $account_id, $contentType);
        return $response;
    }
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\PostsListResponse|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1, HTTP status code, HTTP response headers (array of strings)
     */
    public function listPostsWithHttpInfo($page = 1, $limit = 10, $offset = null, $source = 'zernio', $status = null, $platform = null, $profile_id = null, $created_by = null, $from_date = null, $to_date = null, $date_from = null, $date_to = null, $include_hidden = false, $search = null, $sort_by = 'scheduled-desc', $account_id = null, string $contentType = self::contentTypes['listPosts'][0])
    {
        $request = $this->listPostsRequest($page, $limit, $offset, $source, $status, $platform, $profile_id, $created_by, $from_date, $to_date, $date_from, $date_to, $include_hidden, $search, $sort_by, $account_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPostsAsync($page = 1, $limit = 10, $offset = null, $source = 'zernio', $status = null, $platform = null, $profile_id = null, $created_by = null, $from_date = null, $to_date = null, $date_from = null, $date_to = null, $include_hidden = false, $search = null, $sort_by = 'scheduled-desc', $account_id = null, string $contentType = self::contentTypes['listPosts'][0])
    {
        return $this->listPostsAsyncWithHttpInfo($page, $limit, $offset, $source, $status, $platform, $profile_id, $created_by, $from_date, $to_date, $date_from, $date_to, $include_hidden, $search, $sort_by, $account_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPostsAsyncWithHttpInfo($page = 1, $limit = 10, $offset = null, $source = 'zernio', $status = null, $platform = null, $profile_id = null, $created_by = null, $from_date = null, $to_date = null, $date_from = null, $date_to = null, $include_hidden = false, $search = null, $sort_by = 'scheduled-desc', $account_id = null, string $contentType = self::contentTypes['listPosts'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listPostsRequest($page = 1, $limit = 10, $offset = null, $source = 'zernio', $status = null, $platform = null, $profile_id = null, $created_by = null, $from_date = null, $to_date = null, $date_from = null, $date_to = null, $include_hidden = false, $search = null, $sort_by = 'scheduled-desc', $account_id = null, string $contentType = self::contentTypes['listPosts'][0])
    {
        ...
        if ($offset !== null && $offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling PostsApi.listPosts, must be bigger than or equal to 0.');
        }
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\PostRetryResponse|\Zernio\Model\RetryPost207Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\GetYouTubeDailyViews400Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2|\Zernio\Model\ErrorResponse|\Zernio\Model\GetInboxVolume400Response
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\PostRetryResponse|\Zernio\Model\RetryPost207Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\GetYouTubeDailyViews400Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2|\Zernio\Model\ErrorResponse|\Zernio\Model\GetInboxVolume400Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\UnpublishPost200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\UnpublishPost200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\PostUpdateResponse|\Zernio\Model\PostPublishIncompleteResponse|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2|\Zernio\Model\ErrorResponse
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\PostUpdateResponse|\Zernio\Model\PostPublishIncompleteResponse|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2|\Zernio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Zernio\Model\UpdatePostMetadata200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2
     */
     ...
     * @throws \Zernio\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zernio\Model\UpdatePostMetadata200Response|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject1|\Zernio\Model\ErrorResponse|\Zernio\Model\InlineObject2, HTTP status code, HTTP response headers (array of strings)
     */
