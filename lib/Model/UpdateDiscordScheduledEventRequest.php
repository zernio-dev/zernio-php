...
/**
 * UpdateDiscordScheduledEventRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDiscordScheduledEventRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateDiscordScheduledEvent_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateDiscordScheduledEventRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateDiscordScheduledEventRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateDiscordScheduledEventRequest., must be smaller than or equal to 1000.');
        }
     ...
     * Sets location
     *
     * @param string|null $location For external events.
     *
     * @return self
     */
    public function setLocation($location)
    {
        ...
        if ((mb_strlen($location) > 100)) {
            throw new \InvalidArgumentException('invalid length for $location when calling UpdateDiscordScheduledEventRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($location) < 1)) {
            throw new \InvalidArgumentException('invalid length for $location when calling UpdateDiscordScheduledEventRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param string|null $status Status transition. Most common: 'cancelled' to cancel an event.
     *
     * @return self
     */
     ...
     * Sets image_data_uri
     *
     * @param string|null $image_data_uri image_data_uri
     *
     * @return self
     */
    public function setImageDataUri($image_data_uri)
    {
        ...
        if ((!preg_match("/^data:image\/(png|jpeg|gif);base64,/", ObjectSerializer::toString($image_data_uri)))) {
            throw new \InvalidArgumentException("invalid value for \$image_data_uri when calling UpdateDiscordScheduledEventRequest., must conform to the pattern /^data:image\/(png|jpeg|gif);base64,/.");
        }
