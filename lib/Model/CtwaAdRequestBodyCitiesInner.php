...
/**
 * CtwaAdRequestBodyCitiesInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CtwaAdRequestBodyCitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CtwaAdRequestBody_cities_inner';
    ...
    */
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $key when calling CtwaAdRequestBodyCitiesInner., must be bigger than or equal to 1.');
        }
