...
/**
 * CreateAdCampaign200Response Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateAdCampaign200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createAdCampaign_200_response';
    ...
    public const CAMPAIGN_ID_EMPTY = '';
     ...
     * @return string[]
     */
    public function getCampaignIdAllowableValues()
    {
        return [
            self::CAMPAIGN_ID_EMPTY,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCampaignIdAllowableValues();
        if (!is_null($this->container['campaign_id']) && !in_array($this->container['campaign_id'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'campaign_id', must be one of '%s'",
                $this->container['campaign_id'],
     ...
     * Sets validate_only
     *
     * @param bool|null $validate_only Always true.
     *
     * @return self
     */
     ...
     * Sets campaign_id
     *
     * @param string|null $campaign_id Empty because no campaign was created.
     *
     * @return self
     */
    public function setCampaignId($campaign_id)
    {
        ...
        $allowedValues = $this->getCampaignIdAllowableValues();
        if (!in_array($campaign_id, $allowedValues, true)) {
