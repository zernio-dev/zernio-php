...
/**
 * ReplaceCampaignNegativeKeywordListsRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ReplaceCampaignNegativeKeywordListsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'replaceCampaignNegativeKeywordLists_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['list_ids']) > 20)) {
            $invalidProperties[] = "invalid value for 'list_ids', number of items must be less than or equal to 20.";
        }
    ...
    public function setListIds($list_ids)
    {
        ...
        if ((count($list_ids) > 20)) {
            throw new \InvalidArgumentException('invalid value for $list_ids when calling ReplaceCampaignNegativeKeywordListsRequest., number of items must be less than or equal to 20.');
        }
