...
/**
 * SearchTweets200ResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class SearchTweets200ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchTweets_200_response_meta';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('newest_id', $data ?? [], null);
    ...
    */
     ...
     * Sets newest_id
     *
     * @param string|null $newest_id newest_id
     *
     * @return self
     */
    public function setNewestId($newest_id)
    {
        if (is_null($newest_id)) {
            array_push($this->openAPINullablesSetToNull, 'newest_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('newest_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets oldest_id
     *
     * @param string|null $oldest_id oldest_id
     *
     * @return self
     */
    public function setOldestId($oldest_id)
    {
        if (is_null($oldest_id)) {
            array_push($this->openAPINullablesSetToNull, 'oldest_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('oldest_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
