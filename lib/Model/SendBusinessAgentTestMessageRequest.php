...
/**
 * SendBusinessAgentTestMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class SendBusinessAgentTestMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sendBusinessAgentTestMessage_request';
    ...
    */
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $message when calling SendBusinessAgentTestMessageRequest., must be smaller than or equal to 4096.');
        }
