...
/**
 * AddAccountSitelinksRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AddAccountSitelinksRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addAccountSitelinks_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sitelinks'] === null) {
            $invalidProperties[] = "'sitelinks' can't be null";
        }
        if ((count($this->container['sitelinks']) > 20)) {
            $invalidProperties[] = "invalid value for 'sitelinks', number of items must be less than or equal to 20.";
        }

        if ((count($this->container['sitelinks']) < 1)) {
            $invalidProperties[] = "invalid value for 'sitelinks', number of items must be greater than or equal to 1.";
        }
    ...
    public function setAccountId($account_id)
    {
        ...
        if ((!preg_match("/^[a-fA-F0-9]{24}$/", ObjectSerializer::toString($account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$account_id when calling AddAccountSitelinksRequest., must conform to the pattern /^[a-fA-F0-9]{24}$/.");
        }
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling AddAccountSitelinksRequest., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($customer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$customer_id when calling AddAccountSitelinksRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Gets sitelinks
     *
     * @return \Zernio\Model\GoogleSitelink[]
     */
     ...
     * Sets sitelinks
     *
     * @param \Zernio\Model\GoogleSitelink[] $sitelinks sitelinks
     *
     * @return self
     */
    public function setSitelinks($sitelinks)
    {
        ...
        if ((count($sitelinks) > 20)) {
            throw new \InvalidArgumentException('invalid value for $sitelinks when calling AddAccountSitelinksRequest., number of items must be less than or equal to 20.');
        }
        if ((count($sitelinks) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sitelinks when calling AddAccountSitelinksRequest., number of items must be greater than or equal to 1.');
        }
