...
/**
 * AddAccountCalloutsRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AddAccountCalloutsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addAccountCallouts_request';
    ...
    */
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling AddAccountCalloutsRequest., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setCallouts($callouts)
    {
        ...
        if ((count($callouts) > 20)) {
            throw new \InvalidArgumentException('invalid value for $callouts when calling AddAccountCalloutsRequest., number of items must be less than or equal to 20.');
        }
        if ((count($callouts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $callouts when calling AddAccountCalloutsRequest., number of items must be greater than or equal to 1.');
        }
