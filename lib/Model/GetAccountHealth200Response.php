...
class GetAccountHealth200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'integration_lane' => 'setIntegrationLane',
    ...
    protected static $getters = [
        ...
        'integration_lane' => 'getIntegrationLane',
    ...
    public const INTEGRATION_LANE_BUSINESS = 'business';
    public const INTEGRATION_LANE_DEVELOPER = 'developer';
     ...
     * @return string[]
     */
    public function getIntegrationLaneAllowableValues()
    {
        return [
            self::INTEGRATION_LANE_BUSINESS,
            self::INTEGRATION_LANE_DEVELOPER,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('integration_lane', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getIntegrationLaneAllowableValues();
        if (!is_null($this->container['integration_lane']) && !in_array($this->container['integration_lane'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'integration_lane', must be one of '%s'",
                $this->container['integration_lane'],
    ...
    /**
     * Gets integration_lane
     *
     * @return string|null
     */
    public function getIntegrationLane()
    {
        return $this->container['integration_lane'];
    }

    /**
     * Sets integration_lane
     *
     * @param string|null $integration_lane TikTok only. The TikTok integration the account is connected through: business (TikTok for Business, Accounts API) or developer (the original integration). Absent on other platforms.
     *
     * @return self
     */
    public function setIntegrationLane($integration_lane)
    {
        if (is_null($integration_lane)) {
            throw new \InvalidArgumentException('non-nullable integration_lane cannot be null');
        }
        $allowedValues = $this->getIntegrationLaneAllowableValues();
        if (!in_array($integration_lane, $allowedValues, true)) {
        ...
        $this->container['integration_lane'] = $integration_lane;
