...
/**
 * AddAdKeywordsRequestKeywordsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AddAdKeywordsRequestKeywordsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addAdKeywords_request_keywords_inner';
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 80)) {
            throw new \InvalidArgumentException('invalid length for $text when calling AddAdKeywordsRequestKeywordsInner., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling AddAdKeywordsRequestKeywordsInner., must be bigger than or equal to 1.');
        }
