...
class CreateCallAdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['platform_post_id']) && (mb_strlen($this->container['platform_post_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'platform_post_id', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets campaign_name
     *
     * @param string|null $campaign_name Exact name for the campaign this request provisions. Omitted keeps `<name> - Campaign`. Ignored with `adSetId` (the ad set already has a campaign).
     *
     * @return self
     */
    public function setCampaignName($campaign_name)
    {
        ...
        if ((mb_strlen($campaign_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $campaign_name when calling CreateCallAdRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets ad_set_name
     *
     * @param string|null $ad_set_name Exact name for the ad set this request provisions. Omitted keeps `<name> - Ad Set`. Ignored with `adSetId`.
     *
     * @return self
     */
    public function setAdSetName($ad_set_name)
    {
        ...
        if ((mb_strlen($ad_set_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $ad_set_name when calling CreateCallAdRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setPlatformPostId($platform_post_id)
    {
        ...
        if ((mb_strlen($platform_post_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $platform_post_id when calling CreateCallAdRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $existing_post_id Alias of platformPostId, kept for existing callers. Sending both with different values is a 400.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param string|null $object_story_id Messaging and CTWA only. Raw Facebook pageId_postId reference, used as object_story_id even with an Instagram account. Mutually exclusive with platformPostId and fresh creative fields.
     *
     * @return self
     */
     ...
     * Sets page_id
     *
     * @param string|null $page_id Facebook Page the ad runs as, when the connection was granted several Pages. Defaults to the Page bound to the connection. Any Page granted to the connection is accepted; other ids answer 400 listing the granted Pages. Same semantics as `pageId` on POST /v1/ads/create.
     *
     * @return self
     */
     ...
     * Sets creatives
     *
     * @param \Zernio\Model\CtwaAdRequestBodyCreativesInner[]|null $creatives Multi-creative shape: N CTWA ads under one campaign + one ad set, sharing budget and targeting. Mutually exclusive with the top-level single-creative fields (`headline` / `body` / `imageUrl` / `video`): setting both is a 400, unlike `POST /v1/ads/create` where the top-level fields are silently ignored in multi-creative mode. Each entry supplies headline, body, and image/video, or a platformPostId or objectStoryId reference. Fresh and existing creatives can be mixed.
     *
     * @return self
     */
