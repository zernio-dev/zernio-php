 ...
 */
class ValidateMedia200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'validateMedia_200_response';
    ...
    protected static $setters = [
        ...
        'type' => 'setType',
        'platform_limits' => 'setPlatformLimits'
    ];
    ...
    protected static $getters = [
        ...
        'type' => 'getType',
        'platform_limits' => 'getPlatformLimits'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('platform_limits', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets error
     *
     * @param string|null $error Error message if valid is false
     *
     * @return self
     */
    ...
    {
        return $this->container['platform_limits'];
    }
     ...
     * @return self
     */
    public function setPlatformLimits($platform_limits)
    {
        if (is_null($platform_limits)) {
            throw new \InvalidArgumentException('non-nullable platform_limits cannot be null');
        }
        $this->container['platform_limits'] = $platform_limits;
