...
/**
 * AddBroadcastRecipientsRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AddBroadcastRecipientsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addBroadcastRecipients_request';
    ...
    */
     ...
     * @return bool|null
     */
    public function getUseSegment()
    {
        return $this->container['use_segment'];
    }

    /**
     * Sets use_segment
     *
     * @param bool|null $use_segment Auto-populate from broadcast segment filters
     *
     * @return self
     */
    public function setUseSegment($use_segment)
    {
        if (is_null($use_segment)) {
            throw new \InvalidArgumentException('non-nullable use_segment cannot be null');
        }
        $this->container['use_segment'] = $use_segment;
