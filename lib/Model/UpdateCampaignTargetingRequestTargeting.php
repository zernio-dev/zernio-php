...
/**
 * UpdateCampaignTargetingRequestTargeting Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCampaignTargetingRequestTargeting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateCampaignTargeting_request_targeting';
    ...
    */
     ...
     * Gets devices
     *
     * @return \Zernio\Model\UpdateCampaignTargetingRequestTargetingDevicesInner[]|null
     */
     ...
     * Sets devices
     *
     * @param \Zernio\Model\UpdateCampaignTargetingRequestTargetingDevicesInner[]|null $devices Devices to include. Devices not listed become excluded (negative) criteria, same contract as the existing devices-only edit.
     *
     * @return self
     */
     ...
     * Gets locations
     *
     * @return \Zernio\Model\UpdateCampaignTargetingRequestTargetingLocations|null
     */
     ...
     * Sets locations
     *
     * @param \Zernio\Model\UpdateCampaignTargetingRequestTargetingLocations|null $locations locations
     *
     * @return self
     */
     ...
     * Sets languages
     *
     * @param string[]|null $languages Google's language codes (ISO 639-1, plus variants such as `zh_CN`), e.g. [\"en\", \"de\"].
     *
     * @return self
     */
     ...
     *
     * @param \Zernio\Model\GoogleLocationTargetingType|null $location_targeting_type location_targeting_type
     *
     * @return self
     */
