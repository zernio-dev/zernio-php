...
/**
 * ConnectedApp Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectedApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectedApp';
    ...
    */
     ...
     * Sets client_name
     *
     * @param string|null $client_name Name the client declared at registration. Registration is open, so this is self-declared and not verified.
     *
     * @return self
     */
     ...
     * Sets redirect_host
     *
     * @param string|null $redirect_host Host of the client's registered redirect URI (non-http schemes are shown as scheme//host). The destination an impostor cannot fake.
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string[]|null $scopes Scopes granted on the most recent token.
     *
     * @return self
     */
     ...
     * Sets last_used_at
     *
     * @param \DateTime|null $last_used_at Last time any of the client's live tokens authenticated a request.
     *
     * @return self
     */
     ...
     * Sets token_count
     *
     * @param int|null $token_count Live tokens held by the client (an active session is typically one access plus one refresh token).
     *
     * @return self
     */
