...
/**
 * XArticleInlineStyleRange Class Doc Comment
 *
 * @category Class
 * @description The offset plus length must not exceed the containing block&#39;s text length.
 * @package  Zernio
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class XArticleInlineStyleRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'XArticleInlineStyleRange';
    ...
    */
    ...
    public function setOffset($offset)
    {
        ...
        if (($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling XArticleInlineStyleRange., must be bigger than or equal to 0.');
        }
    ...
    public function setLength($length)
    {
        ...
        if (($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling XArticleInlineStyleRange., must be bigger than or equal to 0.');
        }
