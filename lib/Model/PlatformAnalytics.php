...
class PlatformAnalytics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Error details when status is failed, or why analytics are unavailable for a published entry (e.g. Google Business Profile, a TikTok upload that never received a video id)
     *
     * @return self
     */
