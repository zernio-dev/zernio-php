...
class InlineObject4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'details' => '\Zernio\Model\InlineObject4Details'
    ];
    ...
    */
     ...
     * Sets dashboard_url
     *
     * @param string|null $dashboard_url Deep-link to send the end-user to. For `free_tier_exceeded` and `twitter_passthrough` this opens the add-payment-method drawer on the Zernio billing page. For `enterprise_required` this is the Zernio enterprise contact page.
     *
     * @return self
     */
     ...
     * Gets details
     *
     * @return \Zernio\Model\InlineObject4Details|null
     */
     ...
     * Sets details
     *
     * @param \Zernio\Model\InlineObject4Details|null $details details
     *
     * @return self
     */
