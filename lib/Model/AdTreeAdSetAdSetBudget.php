...
class AdTreeAdSetAdSetBudget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets daily
     *
     * @param float|null $daily LinkedIn only. See `budget.daily`.
     *
     * @return self
     */
     ...
     * Sets lifetime
     *
     * @param float|null $lifetime LinkedIn only. See `budget.lifetime`.
     *
     * @return self
     */
     ...
     * Sets pacing
     *
     * @param string|null $pacing LinkedIn only. See `budget.pacing`.
     *
     * @return self
     */
