 ...
 */
class UploadWhatsAppFlowJsonRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'uploadWhatsAppFlowJson_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['flow_json'] === null) {
            $invalidProperties[] = "'flow_json' can't be null";
        }
