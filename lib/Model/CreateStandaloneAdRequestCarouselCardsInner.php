...
/**
 * CreateStandaloneAdRequestCarouselCardsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateStandaloneAdRequestCarouselCardsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createStandaloneAd_request_carouselCards_inner';
    ...
    */
     ...
     * Sets image_url
     *
     * @param string $image_url Card image; uploaded to the ad account and referenced by hash.
     *
     * @return self
     */
     ...
     * Sets headline
     *
     * @param string|null $headline Card headline, shown below the card image.
     *
     * @return self
     */
    public function setHeadline($headline)
    {
        ...
        if ((mb_strlen($headline) > 255)) {
            throw new \InvalidArgumentException('invalid length for $headline when calling CreateStandaloneAdRequestCarouselCardsInner., must be smaller than or equal to 255.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Card description, shown under the headline.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateStandaloneAdRequestCarouselCardsInner., must be smaller than or equal to 255.');
        }
     ...
     * Sets call_to_action
     *
     * @param string|null $call_to_action Card CTA override. Defaults to the top-level callToAction; same enum.
     *
     * @return self
     */
