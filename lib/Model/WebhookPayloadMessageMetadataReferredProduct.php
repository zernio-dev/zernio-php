...
/**
 * WebhookPayloadMessageMetadataReferredProduct Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookPayloadMessageMetadataReferredProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookPayloadMessage_metadata_referredProduct';
    ...
    */
     ...
     * Sets catalog_id
     *
     * @param string|null $catalog_id Meta catalog the product belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $product_retailer_id Retailer ID (SKU) of the product being asked about.
     *
     * @return self
     */
