...
/**
 * OnWhatsAppNumberDeclinedRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class OnWhatsAppNumberDeclinedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'onWhatsAppNumberDeclined_request';
    ...
    public const EVENT_WHATSAPP_NUMBER_DECLINED = 'whatsapp.number.declined';
    ...
    {
        return [
            self::EVENT_WHATSAPP_NUMBER_DECLINED,
        ];
    }
