...
/**
 * ListAdNegativeKeywordLists200Response Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ListAdNegativeKeywordLists200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listAdNegativeKeywordLists_200_response';
    ...
    protected static $openAPITypes = [
        'lists' => '\Zernio\Model\AdNegativeKeywordList[]',
        'customer_id' => 'string',
        'cached_at' => '\DateTime',
        'stale' => 'bool'
    ];
    ...
    */
     ...
     * Gets lists
     *
     * @return \Zernio\Model\AdNegativeKeywordList[]|null
     */
     ...
     * Sets lists
     *
     * @param \Zernio\Model\AdNegativeKeywordList[]|null $lists lists
     *
     * @return self
     */
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($customer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$customer_id when calling ListAdNegativeKeywordLists200Response., must conform to the pattern /^\\d+$/.");
        }
