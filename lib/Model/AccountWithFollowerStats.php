 ...
 */
class AccountWithFollowerStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountWithFollowerStats';
    ...
    */
     ...
     *
     * @param string|null $parent_account_id Reference to the parent posting SocialAccount. Set for ads accounts that share or derive from a posting account's OAuth token. null for standalone ads (Google Ads) and all posting accounts. Meta ads business-login accounts also have no parent.
     *
     * @return self
     */
    ...
    /**
     * Gets current_followers
     *
     * @return float|null
     */
    public function getCurrentFollowers()
    {
        return $this->container['current_followers'];
    }

    /**
     * Sets current_followers
     *
     * @param float|null $current_followers Current follower count
     *
     * @return self
     */
    public function setCurrentFollowers($current_followers)
    {
        if (is_null($current_followers)) {
            throw new \InvalidArgumentException('non-nullable current_followers cannot be null');
        }
        $this->container['current_followers'] = $current_followers;
     ...
     * Sets growth
     *
     * @param float|null $growth Follower change over period
     *
     * @return self
     */
    ...
    /**
     * Gets growth_percentage
     *
     * @return float|null
     */
    public function getGrowthPercentage()
    {
        return $this->container['growth_percentage'];
    }

    /**
     * Sets growth_percentage
     *
     * @param float|null $growth_percentage Percentage growth
     *
     * @return self
     */
    public function setGrowthPercentage($growth_percentage)
    {
        if (is_null($growth_percentage)) {
            throw new \InvalidArgumentException('non-nullable growth_percentage cannot be null');
        }
        $this->container['growth_percentage'] = $growth_percentage;
     ...
     * Sets data_points
     *
     * @param float|null $data_points Number of historical snapshots
     *
     * @return self
     */
