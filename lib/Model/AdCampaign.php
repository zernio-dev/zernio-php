...
class AdCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $platform_campaign_status Raw platform-level campaign status (Meta `effective_status`; ChatGPT (OpenAI): the campaign's own switch, active / paused / archived).
     *
     * @return self
     */
     ...
     * Sets bid_amount
     *
     * @param float|null $bid_amount Representative bid from the top-spending ad set (whole currency units). Meta: populated when bidStrategy is LOWEST_COST_WITH_BID_CAP or COST_CAP. LinkedIn: the campaign unitCost, ungated, where 0 is a real delivery-stopping value.
     *
     * @return self
     */
     ...
     *
     * @param float|null $roas_average_floor Representative ROAS floor from the top-spending ad set. Decimal multiplier (2.0 = 2.0x).
     *
     * @return self
     */
