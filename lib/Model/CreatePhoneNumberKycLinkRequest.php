...
/**
 * CreatePhoneNumberKycLinkRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreatePhoneNumberKycLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createPhoneNumberKycLink_request';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CreatePhoneNumberKycLinkRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CreatePhoneNumberKycLinkRequest., must be bigger than or equal to 2.');
        }
     ...
     * Gets branding
     *
     * @return \Zernio\Model\CreatePhoneNumberKycLinkRequestBranding|null
     */
     ...
     * Sets branding
     *
     * @param \Zernio\Model\CreatePhoneNumberKycLinkRequestBranding|null $branding branding
     *
     * @return self
     */
