...
/**
 * WebhookPayloadPhoneNumberStockAvailable Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookPayloadPhoneNumberStockAvailable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookPayloadPhoneNumberStockAvailable';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'event' => 'string',
        'stock' => '\Zernio\Model\WebhookPayloadPhoneNumberStockAvailableStock',
        'timestamp' => '\DateTime'
    ];
    ...
    public const EVENT_PHONE_NUMBER_STOCK_AVAILABLE = 'phone_number.stock_available';
    ...
    {
        return [
            self::EVENT_PHONE_NUMBER_STOCK_AVAILABLE,
        ];
    }
    ...
    */
     ...
     * Gets stock
     *
     * @return \Zernio\Model\WebhookPayloadPhoneNumberStockAvailableStock
     */
     ...
     * Sets stock
     *
     * @param \Zernio\Model\WebhookPayloadPhoneNumberStockAvailableStock $stock stock
     *
     * @return self
     */
