...
class AnalyticsListResponsePostsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets thumbnail_url
     *
     * @param string|null $thumbnail_url Cover image URL. Facebook and Instagram covers whose Meta CDN link expired are re-read from Meta and served from Zernio storage, so that URL does not expire and can be cached.
     *
     * @return self
     */
