...
class AnalyticsDeltaEntryMetrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['website_clicks'] === null) {
            $invalidProperties[] = "'website_clicks' can't be null";
        }
        if ($this->container['impression_sources'] === null) {
            $invalidProperties[] = "'impression_sources' can't be null";
        }
        if ($this->container['audience_types'] === null) {
            $invalidProperties[] = "'audience_types' can't be null";
        }
        if ($this->container['audience_countries'] === null) {
            $invalidProperties[] = "'audience_countries' can't be null";
        }
     ...
     * Sets website_clicks
     *
     * @param int $website_clicks TikTok business lane: website-link clicks attributed to the post (also inside clicks)
     *
     * @return self
     */
     ...
     *
     * @param array<string,float> $impression_sources TikTok business lane: share of views by surface (forYou, follow, search, personalProfile, sound, directMessage, other), fractions 0 to 1. Empty object elsewhere.
     *
     * @return self
     */
     ...
     * Sets audience_types
     *
     * @param array<string,float> $audience_types TikTok business lane: follower / nonFollower and newViewer / returnViewer shares, fractions 0 to 1. Empty object elsewhere.
     *
     * @return self
     */
     ...
     *
     * @param array<string,float> $audience_countries TikTok business lane: viewer-country shares keyed by ISO-3166 alpha-2, fractions 0 to 1, top 20 with the tail in `other`. Empty object elsewhere.
     *
     * @return self
     */
