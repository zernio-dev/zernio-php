...
/**
 * CreateStandaloneAdRequestImages Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateStandaloneAdRequestImages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createStandaloneAd_request_images';
    ...
    */
     ...
     * Sets landscape
     *
     * @param string|null $landscape Landscape 1.91:1 marketing image URL (e.g. 1200x628). Also accepted via the top-level `imageUrl` for backward compatibility.
     *
     * @return self
     */
     ...
     * Sets square
     *
     * @param string|null $square Square 1:1 marketing image URL (e.g. 1080x1080). Required for Google Display.
     *
     * @return self
     */
