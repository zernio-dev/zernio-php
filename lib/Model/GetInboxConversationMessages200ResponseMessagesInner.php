...
class GetInboxConversationMessages200ResponseMessagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'subject' => 'string',
        'story_reply' => '\Zernio\Model\GetInboxConversationMessages200ResponseMessagesInnerStoryReply',
    ...
    */
     ...
     * Gets story_reply
     *
     * @return \Zernio\Model\GetInboxConversationMessages200ResponseMessagesInnerStoryReply|null
     */
     ...
     * Sets story_reply
     *
     * @param \Zernio\Model\GetInboxConversationMessages200ResponseMessagesInnerStoryReply|null $story_reply story_reply
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_story_mention Instagram only. True when the message is the user mentioning the account in their own story. The story itself is the `share` attachment with `originalType: \"story_mention\"`. Also set on imported history, read off Meta's `story.mention`.
     *
     * @return self
     */
