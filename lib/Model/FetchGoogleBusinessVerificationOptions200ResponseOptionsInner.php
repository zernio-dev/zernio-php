...
/**
 * FetchGoogleBusinessVerificationOptions200ResponseOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class FetchGoogleBusinessVerificationOptions200ResponseOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'fetchGoogleBusinessVerificationOptions_200_response_options_inner';
    ...
    {
        return [
            self::VERIFICATION_METHOD_ADDRESS,
            self::VERIFICATION_METHOD_EMAIL,
            self::VERIFICATION_METHOD_PHONE_CALL,
            self::VERIFICATION_METHOD_SMS,
            self::VERIFICATION_METHOD_AUTO,
            self::VERIFICATION_METHOD_VETTED_PARTNER,
        ];
    }
    ...
    */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Present for PHONE_CALL / SMS.
     *
     * @return self
     */
