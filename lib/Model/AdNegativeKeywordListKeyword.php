...
/**
 * AdNegativeKeywordListKeyword Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AdNegativeKeywordListKeyword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdNegativeKeywordListKeyword';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['criterion_id']) && !preg_match("/^\\d+$/", $this->container['criterion_id'])) {
            $invalidProperties[] = "invalid value for 'criterion_id', must be conform to the pattern /^\\d+$/.";
        }
     ...
     * Sets criterion_id
     *
     * @param string|null $criterion_id Google shared criterion id.
     *
     * @return self
     */
    public function setCriterionId($criterion_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($criterion_id)))) {
            throw new \InvalidArgumentException("invalid value for \$criterion_id when calling AdNegativeKeywordListKeyword., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Sets text
     *
     * @param string|null $text Keyword text.
     *
     * @return self
     */
