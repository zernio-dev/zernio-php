...
/**
 * AddAccountStructuredSnippetsRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AddAccountStructuredSnippetsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addAccountStructuredSnippets_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['structured_snippets'] === null) {
            $invalidProperties[] = "'structured_snippets' can't be null";
        }
        if ((count($this->container['structured_snippets']) > 20)) {
            $invalidProperties[] = "invalid value for 'structured_snippets', number of items must be less than or equal to 20.";
        }

        if ((count($this->container['structured_snippets']) < 1)) {
    ...
    public function setAccountId($account_id)
    {
        ...
        if ((!preg_match("/^[a-fA-F0-9]{24}$/", ObjectSerializer::toString($account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$account_id when calling AddAccountStructuredSnippetsRequest., must conform to the pattern /^[a-fA-F0-9]{24}$/.");
        }
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling AddAccountStructuredSnippetsRequest., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($customer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$customer_id when calling AddAccountStructuredSnippetsRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     *
     * @return \Zernio\Model\GoogleStructuredSnippet[]
     */
     ...
     *
     * @param \Zernio\Model\GoogleStructuredSnippet[] $structured_snippets structured_snippets
     *
     * @return self
     */
    public function setStructuredSnippets($structured_snippets)
    {
        ...
        if ((count($structured_snippets) > 20)) {
            throw new \InvalidArgumentException('invalid value for $structured_snippets when calling AddAccountStructuredSnippetsRequest., number of items must be less than or equal to 20.');
        }
        if ((count($structured_snippets) < 1)) {
            throw new \InvalidArgumentException('invalid length for $structured_snippets when calling AddAccountStructuredSnippetsRequest., number of items must be greater than or equal to 1.');
        }
