...
/**
 * UpdateCampaignAssetsRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCampaignAssetsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateCampaignAssets_request';
    ...
    protected static $openAPITypes = [
        ...
        'customer_id' => 'string',
        'updates' => '\Zernio\Model\GoogleAssetUpdate[]'
    ];
    ...
    */
    ...
    public function setAccountId($account_id)
    {
        ...
        if ((!preg_match("/^[a-fA-F0-9]{24}$/", ObjectSerializer::toString($account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$account_id when calling UpdateCampaignAssetsRequest., must conform to the pattern /^[a-fA-F0-9]{24}$/.");
        }
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling UpdateCampaignAssetsRequest., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($customer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$customer_id when calling UpdateCampaignAssetsRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Gets updates
     *
     * @return \Zernio\Model\GoogleAssetUpdate[]
     */
     ...
     * Sets updates
     *
     * @param \Zernio\Model\GoogleAssetUpdate[] $updates updates
     *
     * @return self
     */
    public function setUpdates($updates)
    {
        ...
        if ((count($updates) > 20)) {
            throw new \InvalidArgumentException('invalid value for $updates when calling UpdateCampaignAssetsRequest., number of items must be less than or equal to 20.');
        }
        if ((count($updates) < 1)) {
            throw new \InvalidArgumentException('invalid length for $updates when calling UpdateCampaignAssetsRequest., number of items must be greater than or equal to 1.');
        }
