...
class PlatformTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets published_at
     *
     * @param \DateTime|null $published_at Timestamp when the post was published to this platform. YouTube uploads a scheduled public video up to 15 minutes early as private with YouTube's own release time, so its entry is published with this set to scheduledFor, the moment the video goes public.
     *
     * @return self
     */
