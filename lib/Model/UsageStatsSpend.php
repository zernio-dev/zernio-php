...
class UsageStatsSpend implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int|null $x_spend_limit_cents Monthly X spend cap set by the account owner, or null if no cap. When current X spend hits this cap, all billable X API activity is paused until the billing period resets or the cap is raised, including publishing, analytics and inbox sync, and likes, reposts and follows.
     *
     * @return self
     */
