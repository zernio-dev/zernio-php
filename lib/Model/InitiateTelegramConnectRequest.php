...
/**
 * InitiateTelegramConnectRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class InitiateTelegramConnectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'initiateTelegramConnect_request';
    ...
    */
     ...
     * Sets profile_id
     *
     * @param string $profile_id The profile ID to connect the account to
     *
     * @return self
     */
