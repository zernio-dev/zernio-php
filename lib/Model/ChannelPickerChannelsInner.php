...
/**
 * ChannelPickerChannelsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ChannelPickerChannelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Channel_picker_channels_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Channel id (C... or G...), the value to send as channelId on POST
     *
     * @return self
     */
     ...
     * Sets is_member
     *
     * @param bool $is_member Whether the Zernio bot is already a member of the channel
     *
     * @return self
     */
