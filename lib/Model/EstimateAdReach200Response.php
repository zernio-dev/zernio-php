...
class EstimateAdReach200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets active
     *
     * @param int|null $active LinkedIn only. LinkedIn's `audienceCounts.active`, verbatim: the active subset of the same audience `lower`/`upper` carry as its `total`. Absent when LinkedIn does not report it; `0` is a real answer, not a missing one.
     *
     * @return self
     */
