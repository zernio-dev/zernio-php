...
/**
 * ReplyToInboxPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ReplyToInboxPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'replyToInboxPost_request';
    ...
    */
     ...
     * Sets comment_id
     *
     * @param string|null $comment_id Reply to specific comment (optional)
     *
     * @return self
     */
    ...
    {
        return $this->container['parent_cid'];
    }

    /**
     * Sets parent_cid
     *
     * @param string|null $parent_cid (Bluesky only) Parent content identifier
     *
     * @return self
     */
    public function setParentCid($parent_cid)
    {
        if (is_null($parent_cid)) {
            throw new \InvalidArgumentException('non-nullable parent_cid cannot be null');
        }
        $this->container['parent_cid'] = $parent_cid;
     ...
     * Sets root_uri
     *
     * @param string|null $root_uri (Bluesky only) Root post URI
     *
     * @return self
     */
     ...
     * Sets root_cid
     *
     * @param string|null $root_cid (Bluesky only) Root post CID
     *
     * @return self
     */
