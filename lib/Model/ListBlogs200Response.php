...
/**
 * ListBlogs200Response Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ListBlogs200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listBlogs_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('blogs', $data ?? [], null);
    ...
    */
     ...
     * Sets blogs
     *
     * @param \Zernio\Model\Blog[]|null $blogs blogs
     *
     * @return self
     */
    ...
    {
        if (is_null($blogs)) {
            throw new \InvalidArgumentException('non-nullable blogs cannot be null');
        }
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor Cursor for the next page; null when there are no more pages.
     *
     * @return self
     */
