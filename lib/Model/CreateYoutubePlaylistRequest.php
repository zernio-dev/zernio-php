...
/**
 * CreateYoutubePlaylistRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateYoutubePlaylistRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createYoutubePlaylist_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('privacy', $data ?? [], 'private');
    }
    ...
    */
     ...
     * Sets title
     *
     * @param string $title Playlist title. Leading and trailing whitespace is removed.
     *
     * @return self
     */
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateYoutubePlaylistRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Optional playlist description.
     *
     * @return self
     */
