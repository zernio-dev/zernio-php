...
class CreateMessagingAdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const DESTINATIONS_WHATSAPP = 'whatsapp';
    public const DESTINATIONS_MESSENGER = 'messenger';
    public const DESTINATIONS_INSTAGRAM_DIRECT = 'instagram_direct';
     ...
     * @return string[]
     */
    public function getDestinationsAllowableValues()
    {
        return [
            self::DESTINATIONS_WHATSAPP,
            self::DESTINATIONS_MESSENGER,
            self::DESTINATIONS_INSTAGRAM_DIRECT,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['destinations']) && (count($this->container['destinations']) > 3)) {
            $invalidProperties[] = "invalid value for 'destinations', number of items must be less than or equal to 3.";
        }

        if (!is_null($this->container['destinations']) && (count($this->container['destinations']) < 2)) {
            $invalidProperties[] = "invalid value for 'destinations', number of items must be greater than or equal to 2.";
        }
    ...
    public function setCampaignName($campaign_name)
    {
        ...
        if ((mb_strlen($campaign_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $campaign_name when calling CreateMessagingAdRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setAdSetName($ad_set_name)
    {
        ...
        if ((mb_strlen($ad_set_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $ad_set_name when calling CreateMessagingAdRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setPlatformPostId($platform_post_id)
    {
        ...
        if ((mb_strlen($platform_post_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $platform_post_id when calling CreateMessagingAdRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setExistingPostId($existing_post_id)
    {
        ...
        if ((mb_strlen($existing_post_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $existing_post_id when calling CreateMessagingAdRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setObjectStoryId($object_story_id)
    {
        ...
        if ((!preg_match("/^\\d+_\\d+$/", ObjectSerializer::toString($object_story_id)))) {
            throw new \InvalidArgumentException("invalid value for \$object_story_id when calling CreateMessagingAdRequest., must conform to the pattern /^\\d+_\\d+$/.");
        }
    ...
    public function setWhatsappPhoneNumber($whatsapp_phone_number)
    {
        ...
        if ((!preg_match("/^\\+[1-9]\\d{6,14}$/", ObjectSerializer::toString($whatsapp_phone_number)))) {
            throw new \InvalidArgumentException("invalid value for \$whatsapp_phone_number when calling CreateMessagingAdRequest., must conform to the pattern /^\\+[1-9]\\d{6,14}$/.");
        }
     ...
     * Sets destination
     *
     * @param string|null $destination Where the conversation opens when the ad is tapped. Set this OR `destinations`, not both.
     *
     * @return self
     */
    ...
    public function setDestinations($destinations)
    {
        ...
        $allowedValues = $this->getDestinationsAllowableValues();
        if (array_diff($destinations, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'destinations', must be one of '%s'",
                    implode("', '", $allowedValues)
                )
            );
        }
        ...
        if ((count($destinations) > 3)) {
            throw new \InvalidArgumentException('invalid value for $destinations when calling CreateMessagingAdRequest., number of items must be less than or equal to 3.');
        }
        if ((count($destinations) < 2)) {
            throw new \InvalidArgumentException('invalid length for $destinations when calling CreateMessagingAdRequest., number of items must be greater than or equal to 2.');
        }
