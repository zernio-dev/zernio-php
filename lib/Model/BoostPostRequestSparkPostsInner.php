...
/**
 * BoostPostRequestSparkPostsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class BoostPostRequestSparkPostsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'boostPost_request_sparkPosts_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['spark_auth_code'] === null) {
            $invalidProperties[] = "'spark_auth_code' can't be null";
        }
     ...
     *
     * @param string $platform_post_id TikTok post (item) id.
     *
     * @return self
     */
     ...
     *
     * @param string $spark_auth_code That post's Spark code.
     *
     * @return self
     */
