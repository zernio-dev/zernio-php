...
class UpdateAdRequestTargetingDevicesInnerOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setBidModifier($bid_modifier)
    {
        ...
        if (($bid_modifier < 0)) {
            throw new \InvalidArgumentException('invalid value for $bid_modifier when calling UpdateAdRequestTargetingDevicesInnerOneOf., must be bigger than or equal to 0.');
        }
