...
/**
 * CampaignAnalyticsResponseAnalyticsImpressionShareCache Class Doc Comment
 *
 * @category Class
 * @description Google only. Cache status of the single date-range impression-share query.
 * @package  Zernio
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CampaignAnalyticsResponseAnalyticsImpressionShareCache implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignAnalyticsResponse_analytics_impressionShareCache';
