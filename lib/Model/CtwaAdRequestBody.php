    ...
    */
    ...
    public function setCampaignName($campaign_name)
    {
        ...
        if ((mb_strlen($campaign_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $campaign_name when calling CtwaAdRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setAdSetName($ad_set_name)
    {
        ...
        if ((mb_strlen($ad_set_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $ad_set_name when calling CtwaAdRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setPlatformPostId($platform_post_id)
    {
        ...
        if ((mb_strlen($platform_post_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $platform_post_id when calling CtwaAdRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setExistingPostId($existing_post_id)
    {
        ...
        if ((mb_strlen($existing_post_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $existing_post_id when calling CtwaAdRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setObjectStoryId($object_story_id)
    {
        ...
        if ((!preg_match("/^\\d+_\\d+$/", ObjectSerializer::toString($object_story_id)))) {
            throw new \InvalidArgumentException("invalid value for \$object_story_id when calling CtwaAdRequestBody., must conform to the pattern /^\\d+_\\d+$/.");
        }
    ...
    public function setWhatsappPhoneNumber($whatsapp_phone_number)
    {
        ...
        if ((!preg_match("/^\\+[1-9]\\d{6,14}$/", ObjectSerializer::toString($whatsapp_phone_number)))) {
            throw new \InvalidArgumentException("invalid value for \$whatsapp_phone_number when calling CtwaAdRequestBody., must conform to the pattern /^\\+[1-9]\\d{6,14}$/.");
        }
