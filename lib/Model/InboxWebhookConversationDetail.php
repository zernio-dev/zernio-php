...
class InboxWebhookConversationDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The platform's conversation id, equal to `conversation.platformConversationId` on inbox webhooks (whose `conversation.id` is Zernio's internal id). Both are accepted by the conversation endpoints.
     *
     * @return self
     */
     ...
     *
     * @param string $platform_conversation_id Same value as `id`.
     *
     * @return self
     */
