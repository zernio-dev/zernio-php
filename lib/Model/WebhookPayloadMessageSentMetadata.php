...
class WebhookPayloadMessageSentMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'meta_interactive' => 'array<string,mixed>',
    ...
    protected static $attributeMap = [
        'meta_interactive' => 'metaInteractive',
        'location' => 'location',
        'contacts' => 'contacts',
    ...
    protected static $setters = [
        'meta_interactive' => 'setMetaInteractive',
    ...
    protected static $getters = [
        'meta_interactive' => 'getMetaInteractive',
    ...
    {
        $this->setIfExists('meta_interactive', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets meta_interactive
     *
     * @return array<string,mixed>|null
     */
    public function getMetaInteractive()
    {
        return $this->container['meta_interactive'];
    }

    /**
     * Sets meta_interactive
     *
     * @param array<string,mixed>|null $meta_interactive Instagram/Facebook only. The buttons, quickReplies and/or template this outgoing message carried, as sent (tracked urls included when link tracking wrapped a button). Absent when the send carried none.
     *
     * @return self
     */
    public function setMetaInteractive($meta_interactive)
    {
        if (is_null($meta_interactive)) {
            throw new \InvalidArgumentException('non-nullable meta_interactive cannot be null');
        }
        $this->container['meta_interactive'] = $meta_interactive;
