...
/**
 * AddMessageReaction200Response Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AddMessageReaction200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addMessageReaction_200_response';
    ...
    */
     ...
     * Sets message_id
     *
     * @param string|null $message_id The Zernio message ID the reaction was resolved against
     *
     * @return self
     */
     ...
     *
     * @param string|null $platform_message_id The platform message ID the reaction was sent for
     *
     * @return self
     */
