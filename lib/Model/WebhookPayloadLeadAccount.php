...
class WebhookPayloadLeadAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['profile_id'] === null && !$this->isNullableSetToNull('profile_id')) {
     ...
     * Sets profile_id
     *
     * @param string|null $profile_id Profile ID of the account that received the lead. Null when the lead has no profile on record.
     *
     * @return self
     */
