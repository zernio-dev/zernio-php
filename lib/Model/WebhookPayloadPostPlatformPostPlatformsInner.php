...
class WebhookPayloadPostPlatformPostPlatformsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'error' => 'string',
        'platform_error' => '\Zernio\Model\PostPlatformError'
    ];
    ...
    */
    ...
    {
        return $this->container['published_url'];
    }

    /**
     * Sets published_url
     *
     * @param string|null $published_url published_url
     *
     * @return self
     */
    public function setPublishedUrl($published_url)
    {
        if (is_null($published_url)) {
            throw new \InvalidArgumentException('non-nullable published_url cannot be null');
        }
        $this->container['published_url'] = $published_url;
     ...
     * Gets platform_error
     *
     * @return \Zernio\Model\PostPlatformError|null
     */
     ...
     * Sets platform_error
     *
     * @param \Zernio\Model\PostPlatformError|null $platform_error platform_error
     *
     * @return self
     */
