...
class SendInboxMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EFFECT_SLAM = 'slam';
    public const EFFECT_LOUD = 'loud';
    public const EFFECT_GENTLE = 'gentle';
    public const EFFECT_INVISIBLE_INK = 'invisibleInk';
    public const EFFECT__ECHO = 'echo';
    public const EFFECT_SPOTLIGHT = 'spotlight';
    public const EFFECT_BALLOONS = 'balloons';
    public const EFFECT_CONFETTI = 'confetti';
    public const EFFECT_LOVE = 'love';
    public const EFFECT_LASERS = 'lasers';
    public const EFFECT_FIREWORKS = 'fireworks';
    public const EFFECT_SHOOTING_STAR = 'shootingStar';
    public const EFFECT_CELEBRATION = 'celebration';
    ...
    public function getEffectAllowableValues()
    {
        return [
            ...
            self::EFFECT_LOUD,
            self::EFFECT_GENTLE,
            self::EFFECT_INVISIBLE_INK,
            self::EFFECT__ECHO,
            self::EFFECT_SPOTLIGHT,
            self::EFFECT_BALLOONS,
            self::EFFECT_CONFETTI,
            self::EFFECT_LOVE,
            self::EFFECT_LASERS,
            self::EFFECT_FIREWORKS,
            self::EFFECT_SHOOTING_STAR,
            self::EFFECT_CELEBRATION,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('contact_card', $data ?? [], null);
    ...
    */
     ...
     * Sets subject
     *
     * @param string|null $subject iMessage only (JSON body only). Bold title line rendered above the message text. Rejected with 400 on other platforms; ignored on voice-message sends.
     *
     * @return self
     */
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling SendInboxMessageRequest., must be smaller than or equal to 1000.');
        }
     ...
     * Sets effect
     *
     * @param string|null $effect iMessage only (JSON body only). Apple screen/bubble animation played when the message arrives. Rejected with 400 on other platforms.
     *
     * @return self
     */
    ...
    {
        return $this->container['contact_card'];
    }

    /**
     * Sets contact_card
     *
     * @param bool|null $contact_card iMessage only (JSON body only). When `true`, attaches the sender's contact card (vCard) so the recipient can save the sender. Counts as message content on its own, so `message` becomes optional.
     *
     * @return self
     */
    public function setContactCard($contact_card)
    {
        if (is_null($contact_card)) {
            throw new \InvalidArgumentException('non-nullable contact_card cannot be null');
        }
        $this->container['contact_card'] = $contact_card;
     ...
     * Sets channel
     *
     * @param string|null $channel iMessage only (JSON body only). Overrides the delivery channel for this one send; the provider otherwise picks it automatically. The sender must carry the matching add-on (SMS, RCS or WhatsApp), or the send fails. Not a default to set on every request. Rejected with 400 on other platforms.
     *
     * @return self
     */
