...
/**
 * GetAdNegativeKeywordList200ResponseList Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class GetAdNegativeKeywordList200ResponseList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAdNegativeKeywordList_200_response_list';
    ...
    protected static $openAPITypes = [
        ...
        'member_count' => 'int',
        'reference_count' => 'int',
        'keywords' => '\Zernio\Model\AdNegativeKeywordListKeyword[]'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling GetAdNegativeKeywordList200ResponseList., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Gets keywords
     *
     * @return \Zernio\Model\AdNegativeKeywordListKeyword[]|null
     */
     ...
     * Sets keywords
     *
     * @param \Zernio\Model\AdNegativeKeywordListKeyword[]|null $keywords keywords
     *
     * @return self
     */
