...
class ListPhoneNumberCountries200ResponseCountriesInnerTypesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $whatsapp_available False for toll_free (WhatsApp does not reliably register toll-free numbers) and for pairs Meta refuses, such as Chilean local (+56 2).
     *
     * @return self
     */
