...
class SearchAdTargeting200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets country_code
     *
     * @param string|null $country_code ISO-3166 alpha-2 of the country a sub-country geo result (city, region, zip, metro) belongs to, when the platform reports it (Meta does). Useful to know whether a location falls under the EU DSA disclosure rules before creating the ad.
     *
     * @return self
     */
