...
class GetInboxPostComments200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets comment
     *
     * @param object|null $comment (Facebook and Instagram only) Present when `commentId` was passed: the requested comment itself, in the same shape as an entry in comments[]. comments[] then holds that comment's replies instead of the post's top-level comments.
     *
     * @return self
     */
