...
/**
 * UpdateBidStrategyRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UpdateBidStrategyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateBidStrategy_request';
    ...
    */
     ...
     * Sets ad_account_id
     *
     * @param string|null $ad_account_id Platform ad account ID (Google customer ID, digits only). Defaults to the account's connected customer.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateBidStrategyRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateBidStrategyRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets target_cpa
     *
     * @param float|null $target_cpa target_cpa
     *
     * @return self
     */
     ...
     * Sets target_roas
     *
     * @param float|null $target_roas target_roas
     *
     * @return self
     */
