...
class AdEngagementCounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets video_views
     *
     * @param int|null $video_views Video views, from the `video_view` action. Meta counts a 3-second view; LinkedIn's own `videoViews` threshold (2 continuous seconds, or 25% of the video) lands under the same key, so compare across platforms with care. For completion-based counts use `videoThruplayWatchedActions`.
     *
     * @return self
     */
