...
class PostAnalytics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets clicks
     *
     * @param int|null $clicks Link clicks where the platform reports them. Always 0 on Facebook Page stories: Meta exposes no link-click metric for stories.
     *
     * @return self
     */
     ...
     * Sets website_clicks
     *
     * @param int|null $website_clicks TikTok accounts connected through the TikTok for Business app only: clicks on the profile website link attributed to this post (T+24-48h). Also counted inside `clicks`, which sums every profile-link type (website, phone, email, address, app download). 0 for other platforms.
     *
     * @return self
     */
     ...
     * Sets audience_types
     *
     * @param array<string,float>|null $audience_types TikTok accounts connected through the TikTok for Business app only: two viewer splits as fractions 0 to 1 (T+24-48h). Each pair sums to 1 when present, `follower` + `nonFollower` and `newViewer` + `returnViewer`; TikTok can report one pair without the other. Empty object when TikTok reports nothing, and for other platforms. Views-weighted across accounts like impressionSources.
     *
     * @return self
     */
