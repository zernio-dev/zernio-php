...
/**
 * EnrollContactsRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class EnrollContactsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'enrollContacts_request';
    ...
    */
     ...
     * Sets channel_ids
     *
     * @param string[]|null $channel_ids Optional. Auto-detected if not provided.
     *
     * @return self
     */
