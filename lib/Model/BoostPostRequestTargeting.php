...
class BoostPostRequestTargeting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'metros' => '\Zernio\Model\UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf[]',
    ...
    */
     ...
     * Sets regions
     *
     * @param \Zernio\Model\UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf[]|null $regions Region/state targeting. `key` from /v1/ads/targeting/search?dimension=geo&geoType=region.
     *
     * @return self
     */
     ...
     * Sets zips
     *
     * @param \Zernio\Model\UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf[]|null $zips Postal/ZIP targeting. `key` is the platform's postal location ID (e.g. Meta `US:94304`).
     *
     * @return self
     */
     ...
     * Sets metros
     *
     * @param \Zernio\Model\UpdateCampaignTargetingRequestTargetingLocationsOneOfRegionsInnerOneOf[]|null $metros DMA / metro-area targeting. `key` is the platform's metro ID (e.g. Meta `DMA:807`).
     *
     * @return self
     */
