...
/**
 * ListCalls200ResponseCallsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ListCalls200ResponseCallsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listCalls_200_response_calls_inner';
    ...
    protected static array $openAPINullables = [
        ...
        'answered_at' => false,
        'ended_at' => false,
        'transferred_at' => false,
        'duration_seconds' => false,
        'end_reason' => false,
        'hangup_cause' => false,
        'sip_hangup_cause' => false,
        'call_errors' => false,
        'recording_url' => false,
        'last_transcript_snippet' => false,
        'transcript' => false,
        'billing' => false,
        'created_at' => false,
        'updated_at' => false,
    ...
    */
    ...
    public function setAnsweredMachine($answered_machine)
    {
        if (is_null($answered_machine)) {
            throw new \InvalidArgumentException('non-nullable answered_machine cannot be null');
        }
    ...
    public function setTransferredAt($transferred_at)
    {
        if (is_null($transferred_at)) {
            throw new \InvalidArgumentException('non-nullable transferred_at cannot be null');
        }
    ...
    public function setSipHangupCause($sip_hangup_cause)
    {
        if (is_null($sip_hangup_cause)) {
            throw new \InvalidArgumentException('non-nullable sip_hangup_cause cannot be null');
        }
    ...
    public function setLastTranscriptSnippet($last_transcript_snippet)
    {
        if (is_null($last_transcript_snippet)) {
            throw new \InvalidArgumentException('non-nullable last_transcript_snippet cannot be null');
        }
     ...
     * Sets contact_name
     *
     * @param string|null $contact_name CRM contact name for the counterparty, when resolved.
     *
     * @return self
     */
