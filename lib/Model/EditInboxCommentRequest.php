...
/**
 * EditInboxCommentRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class EditInboxCommentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'editInboxComment_request';
    ...
    */
     ...
     * Sets platform
     *
     * @param string $platform Only Reddit supports editing a comment
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string $content The new comment body
     *
     * @return self
     */
    public function setContent($content)
    {
        ...
        if ((mb_strlen($content) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content when calling EditInboxCommentRequest., must be bigger than or equal to 1.');
        }
