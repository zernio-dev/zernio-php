...
/**
 * ReplaceAdAudienceCompaniesRequestCompaniesInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ReplaceAdAudienceCompaniesRequestCompaniesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'replaceAdAudienceCompanies_request_companies_inner';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReplaceAdAudienceCompaniesRequestCompaniesInner., must be smaller than or equal to 255.');
        }
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 100)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling ReplaceAdAudienceCompaniesRequestCompaniesInner., must be smaller than or equal to 100.');
        }
    ...
    public function setWebsite($website)
    {
        ...
        if ((mb_strlen($website) > 100)) {
            throw new \InvalidArgumentException('invalid length for $website when calling ReplaceAdAudienceCompaniesRequestCompaniesInner., must be smaller than or equal to 100.');
        }
