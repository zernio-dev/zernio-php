...
class WebhookPayloadCommentCommentAuthor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets is_own_account
     *
     * @param bool|null $is_own_account True when this comment was authored by the connected account itself. Populated on the Instagram and Facebook realtime webhooks (Meta re-delivers the account's own replies as comments events) and on TikTok, where it is inferred: comments created through this API are always flagged, and once the account's own author identifier is known (from one of those or from a comments listing) every author is compared against it. Absent means not evaluated, never \"not the account\".
     *
     * @return self
     */
