 ...
 */
class SelectSnapchatProfile200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'selectSnapchatProfile_200_response';
    ...
    */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url Redirect URL with connection params (if provided in request)
     *
     * @return self
     */
