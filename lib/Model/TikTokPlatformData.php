    ...
    */
    ...
    public function setVideoOriginalSoundVolume($video_original_sound_volume)
    {
        ...
        if (($video_original_sound_volume > 100)) {
            throw new \InvalidArgumentException('invalid value for $video_original_sound_volume when calling TikTokPlatformData., must be smaller than or equal to 100.');
        }
        if (($video_original_sound_volume < 0)) {
            throw new \InvalidArgumentException('invalid value for $video_original_sound_volume when calling TikTokPlatformData., must be bigger than or equal to 0.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Optional long-form caption for photo posts (max 4000 chars). Recommended when content exceeds 90 chars, as photo titles are auto-truncated. Falls back to the post content when omitted.
     *
     * @return self
     */
