...
/**
 * TargetingSpecCitiesInnerOneOf Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class TargetingSpecCitiesInnerOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TargetingSpec_cities_inner_oneOf';
    ...
    */
     ...
     * Sets distance_unit
     *
     * @param string|null $distance_unit Required if radius is set.
     *
     * @return self
     */
