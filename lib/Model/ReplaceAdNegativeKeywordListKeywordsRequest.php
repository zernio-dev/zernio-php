...
/**
 * ReplaceAdNegativeKeywordListKeywordsRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class ReplaceAdNegativeKeywordListKeywordsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'replaceAdNegativeKeywordListKeywords_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['keywords']) > 5000)) {
    ...
    public function setAccountId($account_id)
    {
        ...
        if ((!preg_match("/^[a-fA-F0-9]{24}$/", ObjectSerializer::toString($account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$account_id when calling ReplaceAdNegativeKeywordListKeywordsRequest., must conform to the pattern /^[a-fA-F0-9]{24}$/.");
        }
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling ReplaceAdNegativeKeywordListKeywordsRequest., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($customer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$customer_id when calling ReplaceAdNegativeKeywordListKeywordsRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Sets keywords
     *
     * @param \Zernio\Model\KeywordEntry[] $keywords Full desired keyword set. Bare strings use broad match. Send [] to clear the list.
     *
     * @return self
     */
    public function setKeywords($keywords)
    {
        ...
        if ((count($keywords) > 5000)) {
            throw new \InvalidArgumentException('invalid value for $keywords when calling ReplaceAdNegativeKeywordListKeywordsRequest., number of items must be less than or equal to 5000.');
        }
