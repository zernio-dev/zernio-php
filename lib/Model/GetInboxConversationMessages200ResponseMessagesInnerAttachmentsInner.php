...
class GetInboxConversationMessages200ResponseMessagesInnerAttachmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_UNSUPPORTED_TYPE = 'unsupported_type';
    ...
    */
     ...
     * Sets refresh_url
     *
     * @param string|null $refresh_url Instagram and Facebook only. Endpoint that resolves this attachment to a working url every time, re-minting it from Meta when the stored one has expired. Safe to store and render indefinitely, except for an attachment with `originalType: \"unsupported_type\"`: Meta cannot re-serve those, so the endpoint answers 404 once the url has expired.
     *
     * @return self
     */
     ...
     * Sets payload
     *
     * @param array<string,mixed>|null $payload Template content (title, subtitle, image, buttons) when type is template
     *
     * @return self
     */
