...
/**
 * CreateAdNegativeKeywordListRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateAdNegativeKeywordListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createAdNegativeKeywordList_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['keywords']) && (count($this->container['keywords']) > 5000)) {
            $invalidProperties[] = "invalid value for 'keywords', number of items must be less than or equal to 5000.";
        }
     ...
     * Sets account_id
     *
     * @param string $account_id Zernio SocialAccount id.
     *
     * @return self
     */
    public function setAccountId($account_id)
    {
        ...
        if ((!preg_match("/^[a-fA-F0-9]{24}$/", ObjectSerializer::toString($account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$account_id when calling CreateAdNegativeKeywordListRequest., must conform to the pattern /^[a-fA-F0-9]{24}$/.");
        }
    ...
    public function setAdAccountId($ad_account_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ad_account_id)))) {
            throw new \InvalidArgumentException("invalid value for \$ad_account_id when calling CreateAdNegativeKeywordListRequest., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($customer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$customer_id when calling CreateAdNegativeKeywordListRequest., must conform to the pattern /^\\d+$/.");
        }
     ...
     * Sets platform
     *
     * @param string|null $platform Optional courtesy field. The resolved account or campaign determines support; other platforms return 501.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Nonempty list name, trimmed before use.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateAdNegativeKeywordListRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateAdNegativeKeywordListRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets keywords
     *
     * @param \Zernio\Model\KeywordEntry[]|null $keywords Full desired keyword set. Bare strings use broad match. Send [] to clear the list.
     *
     * @return self
     */
    public function setKeywords($keywords)
    {
        ...
        if ((count($keywords) > 5000)) {
            throw new \InvalidArgumentException('invalid value for $keywords when calling CreateAdNegativeKeywordListRequest., number of items must be less than or equal to 5000.');
        }
