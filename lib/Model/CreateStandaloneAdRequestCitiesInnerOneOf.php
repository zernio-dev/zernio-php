...
/**
 * CreateStandaloneAdRequestCitiesInnerOneOf Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateStandaloneAdRequestCitiesInnerOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createStandaloneAd_request_cities_inner_oneOf';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key City id from /v1/ads/targeting/search results (Meta city key, Google geo target constant id, TikTok location id).
     *
     * @return self
     */
