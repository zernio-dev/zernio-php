...
/**
 * CreateGoogleBusinessMediaRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateGoogleBusinessMediaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createGoogleBusinessMedia_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('media_format', $data ?? [], 'PHOTO');
    ...
    */
     ...
     * Sets source_url
     *
     * @param string $source_url Publicly accessible image URL
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string|null $category Where the photo appears on the listing
     *
     * @return self
     */
