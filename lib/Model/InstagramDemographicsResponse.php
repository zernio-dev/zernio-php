 ...
 */
class InstagramDemographicsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstagramDemographicsResponse';
    ...
    public const METRIC_FOLLOWER_DEMOGRAPHICS = 'follower_demographics';
    public const METRIC_ENGAGED_AUDIENCE_DEMOGRAPHICS = 'engaged_audience_demographics';
    public const TIMEFRAME_THIS_WEEK = 'this_week';
    public const TIMEFRAME_THIS_MONTH = 'this_month';
    ...
    {
        return [
            self::METRIC_FOLLOWER_DEMOGRAPHICS,
            self::METRIC_ENGAGED_AUDIENCE_DEMOGRAPHICS,
        ];
    }
    ...
    {
        return [
            self::TIMEFRAME_THIS_WEEK,
            self::TIMEFRAME_THIS_MONTH,
        ];
    }
    ...
    */
     ...
     * Sets timeframe
     *
     * @param string|null $timeframe The timeframe used for demographic data
     *
     * @return self
     */
