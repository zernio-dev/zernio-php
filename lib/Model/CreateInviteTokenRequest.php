...
/**
 * CreateInviteTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class CreateInviteTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createInviteToken_request';
    ...
    */
     ...
     * Sets scope
     *
     * @param string $scope 'all' grants access to all profiles, 'profiles' restricts to specific profiles
     *
     * @return self
     */
     ...
     * Sets profile_ids
     *
     * @param string[]|null $profile_ids Required if scope is 'profiles'. Array of profile IDs to grant access to.
     *
     * @return self
     */
