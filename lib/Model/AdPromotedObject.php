...
/**
 * AdPromotedObject Class Doc Comment
 *
 * @category Class
 ...
 */
class AdPromotedObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ad_promotedObject';
    ...
    */
     ...
     *
     * @param string|null $custom_event_type Conversion event type (e.g. PURCHASE, LEAD, COMPLETE_REGISTRATION, ADD_TO_CART)
     *
     * @return self
     */
     ...
     * Sets pixel_id
     *
     * @param string|null $pixel_id Meta pixel ID
     *
     * @return self
     */
     ...
     * Sets page_id
     *
     * @param string|null $page_id Facebook page ID
     *
     * @return self
     */
     ...
     * Sets application_id
     *
     * @param string|null $application_id Facebook app ID
     *
     * @return self
     */
     ...
     * Sets product_set_id
     *
     * @param string|null $product_set_id Product catalog set ID
     *
     * @return self
     */
