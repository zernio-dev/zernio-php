...
/**
 * XArticleEntityOneOfValueData Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class XArticleEntityOneOfValueData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'XArticleEntity_oneOf_value_data';
    ...
    */
    ...
    public function setPostId($post_id)
    {
        ...
        if ((mb_strlen($post_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $post_id when calling XArticleEntityOneOfValueData., must be bigger than or equal to 1.');
        }
