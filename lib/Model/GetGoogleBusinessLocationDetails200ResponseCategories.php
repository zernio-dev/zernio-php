 ...
 */
class GetGoogleBusinessLocationDetails200ResponseCategories implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getGoogleBusinessLocationDetails_200_response_categories';
    ...
    {
        $this->setIfExists('primary_category', $data ?? [], null);
    ...
    */
    ...
    public function setPrimaryCategory($primary_category)
    {
        if (is_null($primary_category)) {
            throw new \InvalidArgumentException('non-nullable primary_category cannot be null');
        }
