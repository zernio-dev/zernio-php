...
/**
 * AdsTimelineResponseRowsInner Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class AdsTimelineResponseRowsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdsTimelineResponse_rows_inner';
    ...
    */
     ...
     * Sets spend
     *
     * @param float|null $spend Native currency units (matches /ads/tree convention).
     *
     * @return self
     */
     ...
     * Sets cpc
     *
     * @param float|null $cpc Cost per click in native currency.
     *
     * @return self
     */
     ...
     * Sets cpm
     *
     * @param float|null $cpm Cost per 1000 impressions in native currency.
     *
     * @return self
     */
     ...
     *
     * @param float|null $cost_per_conversion cost_per_conversion
     *
     * @return self
     */
     ...
     * Sets actions
     *
     * @param array<string,float>|null $actions Per-action-type counts merged across all ads on this day. Keys are platform-native action types.
     *
     * @return self
     */
     ...
     * Sets action_values
     *
     * @param array<string,float>|null $action_values Monetary mirror of `actions` in native currency.
     *
     * @return self
     */
     ...
     * Sets purchase_value
     *
     * @param float|null $purchase_value Sum of purchase-type action values on this day, native currency.
     *
     * @return self
     */
     ...
     * Sets roas
     *
     * @param float|null $roas Derived purchaseValue / spend.
     *
     * @return self
     */
