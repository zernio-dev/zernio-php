...
class WhatsAppCommerceSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('is_cart_enabled', $data ?? [], null);
        $this->setIfExists('is_catalog_visible', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $is_cart_enabled is_cart_enabled
     *
     * @return self
     */
    public function setIsCartEnabled($is_cart_enabled)
    {
        if (is_null($is_cart_enabled)) {
            throw new \InvalidArgumentException('non-nullable is_cart_enabled cannot be null');
        }
     ...
     *
     * @param bool|null $is_catalog_visible is_catalog_visible
     *
     * @return self
     */
    public function setIsCatalogVisible($is_catalog_visible)
    {
        if (is_null($is_catalog_visible)) {
            throw new \InvalidArgumentException('non-nullable is_catalog_visible cannot be null');
        }
