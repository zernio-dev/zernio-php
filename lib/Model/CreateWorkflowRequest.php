...
class CreateWorkflowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createWorkflow_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('platform', $data ?? [], 'whatsapp');
    ...
    */
     ...
     * Sets entry_node_id
     *
     * @param string|null $entry_node_id The trigger node id; derived from the single trigger node if omitted
     *
     * @return self
     */
