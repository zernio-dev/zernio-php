...
/**
 * WebhookPayloadAnalyticsSynced Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookPayloadAnalyticsSynced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookPayloadAnalyticsSynced';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'event' => 'string',
        'account' => '\Zernio\Model\WebhookPayloadAnalyticsSyncedAccount',
        'sync' => '\Zernio\Model\WebhookPayloadAnalyticsSyncedSync',
        'timestamp' => '\DateTime'
    ];
    ...
    public const EVENT_ANALYTICS_SYNCED = 'analytics.synced';
    ...
    */
     ...
     * Gets account
     *
     * @return \Zernio\Model\WebhookPayloadAnalyticsSyncedAccount
     */
     ...
     * Sets account
     *
     * @param \Zernio\Model\WebhookPayloadAnalyticsSyncedAccount $account account
     *
     * @return self
     */
     ...
     * Gets sync
     *
     * @return \Zernio\Model\WebhookPayloadAnalyticsSyncedSync
     */
     ...
     * Sets sync
     *
     * @param \Zernio\Model\WebhookPayloadAnalyticsSyncedSync $sync sync
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime $timestamp UTC time at which Zernio generated this event (set once when the event payload is built, before delivery is queued).
     *
     * @return self
     */
