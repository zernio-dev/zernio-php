...
/**
 * UpdateCampaignTargetingRequestTargetingDevicesInnerOneOf Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCampaignTargetingRequestTargetingDevicesInnerOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateCampaignTargeting_request_targeting_devices_inner_oneOf';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bid_modifier'] === null) {
            $invalidProperties[] = "'bid_modifier' can't be null";
        }
     ...
     * Sets bid_modifier
     *
     * @param float $bid_modifier Bid modifier for this device; devices without one use the campaign's base bid.
     *
     * @return self
     */
