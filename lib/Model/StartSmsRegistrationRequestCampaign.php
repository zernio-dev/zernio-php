...
class StartSmsRegistrationRequestCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets message_flow
     *
     * @param string $message_flow How a recipient ends up receiving your messages (the opt-in flow). Include a link to the page or form where they opt in, because carrier reviewers reject campaigns whose consent they can't verify.
     *
     * @return self
     */
