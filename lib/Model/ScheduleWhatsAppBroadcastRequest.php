...
/**
 * ScheduleWhatsAppBroadcastRequest Class Doc Comment
 *
 * @category Class
 * @package  Late
 * @author   OpenAPI Generator team
 ...
 */
class ScheduleWhatsAppBroadcastRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scheduleWhatsAppBroadcast_request';
    ...
    */
     ...
     * Sets scheduled_at
     *
     * @param \DateTime $scheduled_at ISO 8601 date-time for sending (must be in the future, max 30 days)
     *
     * @return self
     */
