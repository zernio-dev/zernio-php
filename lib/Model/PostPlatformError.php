...
/**
 * PostPlatformError Class Doc Comment
 *
 * @category Class
 ...
 */
class PostPlatformError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPlatformError';
    ...
    */
     ...
     * Sets code
     *
     * @param int|null $code Meta error code, when Meta sent one.
     *
     * @return self
     */
     ...
     * Sets subcode
     *
     * @param int|null $subcode Meta error_subcode, when Meta sent one.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message The platform's raw error message or media processing status text.
     *
     * @return self
     */
