...
class UpdateWebhookSettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EVENTS_WHATSAPP_ACCOUNT_NAME_STATUS_UPDATED = 'whatsapp.account.name_status_updated';
    ...
    public const EVENTS_SMS_REGISTRATION_ACTION_REQUIRED = 'sms.registration.action_required';
    public const EVENTS_SMS_REGISTRATION_STATUS_UPDATED = 'sms.registration.status_updated';
    ...
    public function getEventsAllowableValues()
    {
        return [
            ...
            self::EVENTS_WHATSAPP_ACCOUNT_NAME_STATUS_UPDATED,
            ...
            self::EVENTS_SMS_REGISTRATION_ACTION_REQUIRED,
            self::EVENTS_SMS_REGISTRATION_STATUS_UPDATED,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['account_ids']) && (count($this->container['account_ids']) > 50)) {
            $invalidProperties[] = "invalid value for 'account_ids', number of items must be less than or equal to 50.";
        }
     ...
     * Sets webhook_id
     *
     * @param string|null $webhook_id Webhook ID to update. Required unless the deprecated `_id` is sent instead.
     *
     * @return self
     */
     ...
     * Sets _id
     *
     * @param string|null $_id Alias of webhookId, kept for existing callers
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets profile_ids
     *
     * @param string[]|null $profile_ids Replaces the subscription's profile allowlist. Send an empty array to receive every profile again. Omitting the field leaves the current list untouched. Every id must be a profile in your team, otherwise the request fails with 404 `profile_not_found` and nothing changes. Applies to events emitted after the update. Sending the stored list back unchanged is accepted without re-validation, so an endpoint stays editable after a listed profile is deleted.
     *
     * @return self
     */
    public function setProfileIds($profile_ids)
    {
        ...
        if ((count($profile_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $profile_ids when calling UpdateWebhookSettingsRequest., number of items must be less than or equal to 50.');
        }
    ...
    public function setAccountIds($account_ids)
    {
        ...
        if ((count($account_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $account_ids when calling UpdateWebhookSettingsRequest., number of items must be less than or equal to 50.');
        }
