...
class CreateAdSetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createAdSet_request';
    ...
    */
     ...
     * Sets platform
     *
     * @param string $platform Only \"google\" is implemented today; every other value returns 501.
     *
     * @return self
     */
     ...
     * Sets campaign_id
     *
     * @param string $campaign_id Google platform campaign ID (numeric) the ad group is created under.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateAdSetRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateAdSetRequest., must be bigger than or equal to 1.');
        }
