...
/**
 * GetWhatsAppNumberInfo200ResponseWaba Class Doc Comment
 *
 * @category Class
 * @package  Zernio
 * @author   OpenAPI Generator team
 ...
 */
class GetWhatsAppNumberInfo200ResponseWaba implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getWhatsAppNumberInfo_200_response_waba';
    ...
    protected static array $openAPINullables = [
        'name' => false,
        'business_verification_status' => false,
        'timezone_id' => false,
        'health_status' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('business_verification_status', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $business_verification_status verified, not_verified, pending, ...
     *
     * @return self
     */
    public function setBusinessVerificationStatus($business_verification_status)
    {
        if (is_null($business_verification_status)) {
            throw new \InvalidArgumentException('non-nullable business_verification_status cannot be null');
        }
     ...
     * Sets timezone_id
     *
     * @param string|null $timezone_id Meta integer timezone-enum id
     *
     * @return self
     */
     ...
     * Sets health_status
     *
     * @param object|null $health_status health_status
     *
     * @return self
     */
