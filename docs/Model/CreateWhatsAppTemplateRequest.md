...
**components** | [**\Zernio\Model\WhatsAppTemplateComponent[]**](WhatsAppTemplateComponent.md) | Template components (header, body, footer, buttons). Required for custom templates, omit when using library_template_name. | [optional]
