...
**expire_count** | **int** | Stop recycling after this many copies have been created. Send null on update to clear this limit. | [optional]
**expire_date** | **\DateTime** | Stop recycling after this date, regardless of count. Send null on update to clear this limit. | [optional]
