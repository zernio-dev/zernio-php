# # GetTikTokCreatorInfo200ResponsePostingLimitsInteractionSettingsAllowStitch
...
**required** | **bool** | Whether tiktokSettings.allow_stitch must be supplied when creating a post. Always true, because TikTok forbids defaulting it. | [optional]
