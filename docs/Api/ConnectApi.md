...
```php
connectAds($platform, $profile_id, $login_mode, $page_id, $account_id, $redirect_url, $headless, $force, $ad_account_id, $ad_account_ids): \Zernio\Model\ConnectAds200Response
```
...
try {
    $result = $apiInstance->connectAds($platform, $profile_id, $login_mode, $page_id, $account_id, $redirect_url, $headless, $force, $ad_account_id, $ad_account_ids);
    print_r($result);
} catch (Exception $e) {
