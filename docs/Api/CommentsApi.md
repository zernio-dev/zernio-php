...
$min_comments = 56; // int | Minimum comment count, applied to each page after pagination
...
| **min_comments** | **int**| Minimum comment count, applied to each page after pagination | [optional] |
